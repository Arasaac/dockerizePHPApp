 ...
 <!-- *************************************************************************************************************************************************  -->     
    ...
    <div id="tabla8_celda3">
		...
		?>
           ...
           <?php } else { ?>	  
			<div id="caja_celda3_titulo"><?php echo 'Vota'; ?></div>
            <div style="height:340px; text-align:center; margin-top:20px; margin-bottom:20px;">
            <iframe src="http://www.peticionpublica.es/widgets/pwidget.aspx?pi=ARASAAC&t=1" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" width="250" height="300" style="border:1px solid #bd3; height:300px;"></iframe>
            </div>
			<?php }  ?>
        </div>
    </div>
