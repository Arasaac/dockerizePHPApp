...
?>
    <title>ARASAAC: <?php echo $translate['lse']; ?>-><?php echo $translate['nociones_basicas']; ?></title>
...
<div class="body_content"> 
	  ...
	  <div class="header">
		...
		<?php echo '<h4>'.$translate['lse'].'->'.$translate['nociones_basicas'].'</h4>'; ?>
		<div id="principal">
          <div id="marco"><?php echo $translate['biblioteca_signos']; ?></div>
          <?php echo $translate['lse_nociones_basicas']; ?>
        </div>
