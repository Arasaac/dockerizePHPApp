...
$actualizar_simbolo=$query->actualizar_simbolo_especial($id_simbolo, $id_palabra, $tipo_simbolo, $idioma, $estado, $castellano, $registrado, $mayusculas, $marco,$contraste);
