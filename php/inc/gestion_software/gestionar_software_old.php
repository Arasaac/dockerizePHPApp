...
<script language="javascript" type="text/javascript">
	...
	function customSave()
		...
		cargar_div('<?php echo $web_envio ?>','titulo='+document.getElementById('titulo').value+'&estado='+document.getElementById('estado').value+'&destacado='+document.getElementById('destacado').value+'&PickArchivos='+document.getElementById('archivos').value+'&PickCapturas='+document.getElementById('capturas').value+'&Pickso='+document.getElementById('so').value+'&PickAutores='+document.getElementById('autores').value+'&PickTipo='+document.getElementById('tipo').value+'&id_licencia='+document.getElementById('licencia').value+'&PickIdiomas='+document.getElementById('idiomas').value+'&url1='+document.getElementById('url1').value+'&url2='+document.getElementById('url2').value+'&url3='+document.getElementById('url3').value+'&id_ficha_software='+document.getElementById('id_ficha_software').value+'&precio='+document.getElementById('precio').value+'','mensaje_actualizacion');
...
<form action="add_ficha_software.php" method="post" name="nuevo_material" id="nuevo_material">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td width="50%" valign="top"><p><strong>Estado:</strong>
        ...
        <p><strong>T&iacute;tulo:</strong>
              <input name="titulo" type="text" id="titulo" size="25" value="<?php echo utf8_encode($row['material_titulo']); ?>" />
          </p>
        ...
        <p>
          <?php 
			...
			$initialValue_descripcion = utf8_encode($row['software_descripcion']);
		 	// Creo la instancia del editor para la descripcion.
			echo $CKEditor->editor("descripcion", $initialValue_descripcion, $config);
		 ?>
        </p>
        <p><strong>Objetivo:</strong></p>
        <p>
         <?php 
			$initialValue_objetivo = utf8_encode($row['software_objetivo']);
		 	// Creo la instancia del editor para la descripcion.
			echo $CKEditor->editor("objetivo", $initialValue_objetivo, $config);
		 ?>
        </p>
        <p><strong>Información adicional:</strong></p>
        <p>
         <?php 
			$initialValue_inf_adicional = utf8_encode($row['software_informacion_adicional']);
		 	// Creo la instancia del editor para la descripcion.
			echo $CKEditor->editor("informacion_adicional", $initialValue_inf_adicional, $config);
		 ?>
        </p>
        <p></p></td>
      <td width="50%" align="left" valign="top"><table cellpadding="0" cellspacing="0">
  <TR>
    <TD colspan="3"><strong>Autores
      <input type="hidden" name="autores" id="autores" />
      <input name="id_ficha_software" type="hidden" id="id_ficha_software" value="<?php echo $id_material; ?>" />
    </strong></TD>
    </TR>
