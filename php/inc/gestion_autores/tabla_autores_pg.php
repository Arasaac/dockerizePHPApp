<p><a href="javascript:void(0);" onClick="cargar_div('inc/gestion_autores/nuevo_autor.php','id=','usuario');"><img src="images/add_user.png" alt="Nuevo autor" width="16" height="16" border="0" /></a>&nbsp;<a href="javascript:void(0);" onClick="cargar_div('inc/gestion_autores/nuevo_autor.php','id=','usuario');">Nuevo autor</a></p><br />
			<div align="center" style="height:550px;">
              <form action="" method="post" name="usuarios" id="usuarios">
				...
				<thead>
                  <tr align="center">
                    <td colspan="2" align="center" class="tabla_linea_inferior">&nbsp;</td>
                    <td width="27%" align="center" class="tabla_linea_inferior"><strong>Autor<span class="list_action_button">
                    ...
                    <td width="17%" align="center" class="tabla_linea_inferior"><strong>web</strong></td>
                    <td width="19%" align="center" class="tabla_linea_inferior"><strong>Email</strong></td>
                  </tr>
                  </thead>
<?php 
...
?>
                  <tr class="<?php echo $color; ?>">
                    <td width="1%" align="center" class="tabla_linea_inferior">
					</td>
                    <td width="7%" align="center" class="tabla_linea_inferior"><a href="javascript:void(0);" onClick="cargar_div('inc/gestion_autores/editar_autor.php','id=<?php echo $row['id_autor'] ?>&pg=<?php echo $pg; ?>','usuario');"><img src="images/vcard_edit.png" alt="Editar autor: <?php echo $row['autor']; ?>" border="0" /></a>                        </td>
