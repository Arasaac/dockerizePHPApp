...
$query=new query();
$translate=$query->get_internacionalizacion_page_content($_SESSION['language'],10); 
...
?>
<h4><?php echo $translate['catalogo_pictogramas_catedu_byn']; ?>:</h4> 
<div style="width:100%">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="5%" align="center" valign="middle"><span style="font-size:9px;"><a class="grey" href="rss/subscripcion.php?t=4&id_tipo=5" target="_blank"><img src="images/rss2.png" alt="<?php echo $translate['subscribirse_este_catalogo']; ?>" title="<?php echo $translate['subscribirse_este_catalogo']; ?>" border="0" /></a><br/>
    </span></td>
    <td width="71%" align="left"><?php echo $translate['explicacion_catalogo_pictogramas_byn']; ?></td>
    <td width="10%" align="center" valign="bottom" style="font-size:9px;"><a class="grey" href="javascript:void(0);" onclick="Effect.BlindDown('avanzada_imagenes');; return false;"><img src="images/kappfinder.gif" alt="<?php echo $translate['busqueda_avanzada']; ?>" title="<?php echo $translate['busqueda_avanzada']; ?>" border="0" /></a><br/>
	    ...
	    <div style="text-align:right; margin-bottom:-25px;"><a href="javascript:void(0);" onclick="Effect.BlindUp('avanzada_imagenes');; return false;"><img src="images/close.gif" alt="<?php echo $translate['cerrar_busqueda_avanzada']; ?>"  title="<?php echo $translate['cerrar_busqueda_avanzada']; ?>" border="0"/></a></div>
                    ...
                    <tr valign="middle">
                      <td><strong><?php echo $translate['tipo_de_palabra']; ?>:
                        ...
                        <input type="button" name="Submit2" value="<?php echo $translate['buscar']; ?>" onClick="cargar_div('inc/public/ultimos_pictogramas_byn.php','id_tipo='+document.busqueda_avanzada.tipo_palabra.value+'&letra='+document.busqueda_avanzada.letra.value+'&filtrado='+document.busqueda_avanzada.filtrado.value+'&orden='+document.busqueda_avanzada.orden.value+'&avanzada=1','principal');" /></td>
                        <p>&nbsp;</p>
                    </tr>
                  </table>
					</form><br />
...
<?php  
				...
				if ($_SESSION['id_language'] > 0) {
					...
					$contar=$query->listar_pictogramas_byn($_SESSION['AUTHORIZED'],$id_tipo,$letra,$filtrado,$orden,$id_subtema);
					$resultados=$query->listar_pictogramas_byn_limit($_SESSION['AUTHORIZED'],$inicial,$cantidad,$id_tipo,$letra,$filtrado,$orden,$id_subtema);
				}
    ...
    <td rowspan="2" valign="top"><div id="derecha" style="display:none; width:150px;">
  ...
  <tr>
	...
	<div align="center">
	  <?php 
        ...
        $content.= "<a href=\"javascript:void(0);\" onclick=\"cargar_div('inc/public/ultimos_pictogramas_byn.php','pg=0&id_tipo=".$id_tipo."&letra=".$letra."&filtrado=".$filtrado."&orden=".$orden."&avanzada=".$_POST['avanzada']."&id_subtema=".$id_subtema."','principal');\"><< </a>&nbsp;";
        ...
        $prev = ($pg - 1);
        $content.= "<a href=\"javascript:void(0);\" onclick=\"cargar_div('inc/public/ultimos_pictogramas_byn.php','pg=".$prev."&id_tipo=".$id_tipo."&letra=".$letra."&filtrado=".$filtrado."&orden=".$orden."&avanzada=".$_POST['avanzada']."&id_subtema=".$id_subtema."','principal');\"> <</a>&nbsp;";
        ...
        if($total_pages >= $limitpages) {
            ...
            for($i = $page_start-$limite_inferior; ($i <= $total_pages & $i <=$page_limit); $i++) {
                ...
                if(($i) >= 0) { 	
                    ...
                    $content.= "<a href=\"javascript:void(0);\" onclick=\"cargar_div('inc/public/ultimos_pictogramas_byn.php','pg=".$i."&id_tipo=".$id_tipo."&letra=".$letra."&filtrado=".$filtrado."&orden=".$orden."&avanzada=".$_POST['avanzada']."&id_subtema=".$id_subtema."','principal');\">".$i."</a>&nbsp;";
                    }
                }
        ...
        $next = ($pg + 1);
        $content.= "<a href=\"javascript:void(0);\" onclick=\"cargar_div('inc/public/ultimos_pictogramas_byn.php','pg=".$next."&id_tipo=".$id_tipo."&letra=".$letra."&filtrado=".$filtrado."&orden=".$orden."&avanzada=".$_POST['avanzada']."&id_subtema=".$id_subtema."','principal');\"> ></a>&nbsp;";
        ...
        $last = $total_pages;
        $content.= "<a href=\"javascript:void(0);\" onclick=\"cargar_div('inc/public/ultimos_pictogramas_byn.php','pg=".$last."&id_tipo=".$id_tipo."&letra=".$letra."&filtrado=".$filtrado."&orden=".$orden."&avanzada=".$_POST['avanzada']."&id_subtema=".$id_subtema."','principal');\">  >></a>&nbsp;";
  ...
  <div align="center">
    <p>
      <span class="little">
	  <?php echo $translate['licencia_cc_pictogramas']; ?></span><br>
