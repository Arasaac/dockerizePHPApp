...
echo '<a name="select" id="select"></a><h4>'.$translate['bibliografia'].'</h4> <br /> ';
?>
...
<li><a href="http://sapiens.ya.com/eninteredvisual/rincon_de_la_ca.htm" target="_blank">http://sapiens.ya.com/eninteredvisual/rincon_de_la_ca.htm</a></li>
    ...
    <br />
    <img src="images/biblioteca.png" border="0" alt="<?php echo $translate['bibliografia']; ?>" title="<?php echo $translate['bibliografia']; ?>"/>
