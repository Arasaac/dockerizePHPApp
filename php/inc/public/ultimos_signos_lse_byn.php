...
$query=new query();
$translate=$query->get_internacionalizacion_page_content($_SESSION['language'],20); 
...
?>
<h4><img src="images/ico_lse.jpg" alt="<?php echo $translate['accesible_personas_sordas']; ?>" title="<?php echo $translate['accesible_personas_sordas']; ?>" border="0" />&nbsp;<?php echo $translate['catalogo_signos_byn']; ?>:</h4>
<div style="width:100%">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="4%" align="center" valign="middle"><a class="grey" href="rss/subscripcion.php?t=4&id_tipo=13" target="_blank"><img src="images/rss2.png" alt="<?php echo $translate['subscribirse_este_catalogo']; ?>" title="<?php echo $translate['subscribirse_este_catalogo']; ?>" border="0" /></a></td>
          <td width="74%" align="left"><?php echo $translate['descripcion_catalogos_imagenes_asza']; ?></td>
	    ...
	    <div style="text-align:right; margin-bottom:-25px;"><a href="javascript:void(0);" onclick="Effect.BlindUp('avanzada_imagenes');; return false;"><img src="images/close.gif" alt="<?php echo $translate['cerrar_busqueda_avanzada']; ?>"  title="<?php echo $translate['cerrar_busqueda_avanzada']; ?>" border="0"/></a></div>
                    ...
                    <tr valign="middle">
                      <td><br /><strong><?php echo $translate['tipo_de_palabra']; ?>:
                        ...
                        <input type="button" name="Submit2" value="<?php echo $translate['buscar']; ?>" onClick="cargar_div('inc/public/ultimos_signos_lse_byn.php','id_tipo='+document.busqueda_avanzada.tipo_palabra.value+'&letra='+document.busqueda_avanzada.letra.value+'&filtrado='+document.busqueda_avanzada.filtrado.value+'&orden='+document.busqueda_avanzada.orden.value+'&avanzada=1','principal');" /><br /><br /></td>
                        <p>&nbsp;</p>
                    </tr>
                  </table>
					</form>
        ...
        <ul id="thelist2">
          <?php  
				...
				if ($_SESSION['id_language'] > 0) {
					...
					$contar=$query->listar_lse_byn($_SESSION['AUTHORIZED'],$id_tipo,$letra,$filtrado,$orden,$id_subtema);
					$resultados=$query->listar_lse_byn_limit($_SESSION['AUTHORIZED'],$inicial,$cantidad,$id_tipo,$letra,$filtrado,$orden,$id_subtema);
				...
				$num_rows2=mysql_num_rows($subtemas);
					...
					if ($num_rows2 > 0) {
						while ($row2=mysql_fetch_array($subtemas)) {
							if ($_SESSION['language']=='es') { 
							?> <li><a href="javascript:cargar_div('inc/public/ultimos_signos_lse_byn.php','id_subtema=<?php echo $row2['id_subtema'] ?>','principal');" title="<?php echo $row2['subtema']; ?>"><?php echo $row2['subtema']; ?></a></li>
                            <?php } else { ?>
                            <li><a href="javascript:cargar_div('inc/public/ultimos_signos_lse_byn.php','id_subtema=<?php echo $row2['id_subtema'] ?>','principal');" title="<?php echo $row2['subtema_'.$_SESSION['language'].'']?>"><?php echo $row2['subtema_'.$_SESSION['language'].'']; ?></a></li>
                      <?php   
					  	   }
						}
					}	
  ...
  <tr>
	...
	<div align="center">
	  <?php 
        ...
        $content.= "<a href=\"javascript:void(0);\" onclick=\"cargar_div('inc/public/ultimos_signos_lse_byn.php','pg=0&id_tipo=".$id_tipo."&letra=".$letra."&filtrado=".$filtrado."&orden=".$orden."&avanzada=".$_POST['avanzada']."&id_subtema=".$id_subtema."','principal');\"><< </a>&nbsp;";
        ...
        $prev = ($pg - 1);
        $content.= "<a href=\"javascript:void(0);\" onclick=\"cargar_div('inc/public/ultimos_signos_lse_byn.php','pg=".$prev."&id_tipo=".$id_tipo."&letra=".$letra."&filtrado=".$filtrado."&orden=".$orden."&avanzada=".$_POST['avanzada']."&id_subtema=".$id_subtema."','principal');\"> <</a>&nbsp;";
        ...
        if($total_pages >= $limitpages) {
            ...
            for($i = $page_start-$limite_inferior; ($i <= $total_pages & $i <=$page_limit); $i++) {
                ...
                if(($i) >= 0) { 	
                    ...
                    $content.= "<a href=\"javascript:void(0);\" onclick=\"cargar_div('inc/public/ultimos_signos_lse_byn.php','pg=".$i."&id_tipo=".$id_tipo."&letra=".$letra."&filtrado=".$filtrado."&orden=".$orden."&avanzada=".$_POST['avanzada']."&id_subtema=".$id_subtema."','principal');\">".$i."</a>&nbsp;";
                    }
                }
        ...
        $next = ($pg + 1);
        $content.= "<a href=\"javascript:void(0);\" onclick=\"cargar_div('inc/public/ultimos_signos_lse_byn.php','pg=".$next."&id_tipo=".$id_tipo."&letra=".$letra."&filtrado=".$filtrado."&orden=".$orden."&avanzada=".$_POST['avanzada']."&id_subtema=".$id_subtema."','principal');\"> ></a>&nbsp;";
        ...
        $last = $total_pages;
        $content.= "<a href=\"javascript:void(0);\" onclick=\"cargar_div('inc/public/ultimos_signos_lse_byn.php','pg=".$last."&id_tipo=".$id_tipo."&letra=".$letra."&filtrado=".$filtrado."&orden=".$orden."&avanzada=".$_POST['avanzada']."&id_subtema=".$id_subtema."','principal');\">  >></a>&nbsp;";
