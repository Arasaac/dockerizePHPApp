       ...
       <table width="100%" border="0" cellspacing="0" cellpadding="0">
         <tr>
           <td width="50%" valign="top"><ul>
             <li><a href="javascript:void(0);" onClick='cargar_div("inc/public/quienes_somos.php","i=","right"); cargar_div("inc/blanco.php","i=","submenu");'>¿<?php echo $translate['que_arasaac']; ?>?</a></li><br />
             <li><a href="javascript:void(0);" onClick='cargar_div("inc/public/condiciones_uso.php","i=","right"); cargar_div("inc/blanco.php","i=","submenu");'><?php echo $translate['condiciones_uso']; ?></a></li><br />
              ...
              <li><a href="javascript:void(0);" onClick='cargar_div("inc/public/listado_enlaces.php","i=","right"); cargar_div("inc/blanco.php","i=","submenu");'><?php echo $translate['otras_webs']; ?></a></li><br />
