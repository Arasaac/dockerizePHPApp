...
$path = "../../importar/videos/acepciones/";
$dir = opendir($path);
while ($elemento = readdir($dir))
{
	if($elemento != "." && $elemento != ".." && $elemento != "duplicadas"){ 
	   ...
	   //if ($num_videos==0) {
			...
			copy ("../../importar/videos/acepciones/".$parte[0].".flv","../../repositorio/LSE_acepciones/".$nueva_imagen."");
			unlink ("../../importar/videos/acepciones/".$parte[0].".flv");
