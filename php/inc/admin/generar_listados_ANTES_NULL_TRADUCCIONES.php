...
switch ($id_listado) {
		...
		while ($row=mysql_fetch_array($result)) {
			...
			$result2 = mysql_query($query2);
				...
				if (mysql_num_rows($result2) == 0) {
					...
					$xls->addRow(Array($row['id_palabra'],utf8_decode($row['palabra']),$definicion));
				}
	...
	$xls->addRow(Array("ID ORDEN RAE","Palabra","Definicion"));
		...
		while ($row=mysql_fetch_array($result)) {
			...
			if (strlen($row['definicion']) > 250) { $definicion=substr($row['definicion'],0,250)."(+)"; } else {  $definicion=$row['definicion'];  }
			$xls->addRow(Array($row['id_orden'],utf8_decode($row['palabra']),$definicion));
	...
	$xls->addRow(Array("ID Palabra","Palabra","Definicion","Pictograma","Imagen","Clipart"));
		...
		if (strlen($row['definicion']) > 250) { $definicion=substr($row['definicion'],0,250)."(+)"; } else {  $definicion=$row['definicion'];  }		
		$xls->addRow(Array($row['id_palabra'],utf8_decode($row['palabra']),$definicion,$is_picto,$is_imagen,$is_clipart));
		}
	...
	$xls->addRow(Array("ID Palabra","Palabra","Definicion","Pictograma","Imagen","Clipart","Nº Pict Color","Nº Pict Negro","Nº Imagenes","Nº Cliparts"));
		...
		if (strlen($row['definicion']) > 250) { $definicion=substr($row['definicion'],0,250)."(+)"; } else {  $definicion=$row['definicion'];  }		
		$xls->addRow(Array($row['id_palabra'],utf8_decode($row['palabra']),$definicion,$is_picto,$is_imagen,$is_clipart,mysql_num_rows($result3),mysql_num_rows($result5),mysql_num_rows($result2),mysql_num_rows($result4)));
		}
 	$xls->download("listado_todas_palabras_indicando_imagen_pictograma_o_clipart.xls");
	break;
	...
	$xls->addRow(Array("ID Imagen","Palabra"));
		...
		if (strlen($row['definicion']) > 250) { $definicion=substr($row['definicion'],0,250)."(+)"; } else {  $definicion=$row['definicion'];  }		
		$xls->addRow(Array($row['id_imagen'],utf8_decode($row['palabra'])));
		}
		...
		while ($row=mysql_fetch_array($result)) {	
					...
					if (mysql_num_rows($result2) > 0) {
						...
						while ($row2=mysql_fetch_array($result2)) {
							...
							$palabras_castellano.=utf8_decode($row2['palabra']).';';
							...
							while ($row3=mysql_fetch_array($traducciones)) {
								...
								switch ($row3['id_idioma']) {
										...
										case 7:
										if ($row3['traduccion']!='sin traduccion' && $row3['traduccion']!='Sin traducción') {
		...
		while ($row=mysql_fetch_array($result)) {	
					...
					if (mysql_num_rows($result2) > 0) {
						...
						while ($row2=mysql_fetch_array($result2)) {
							...
							$palabras_castellano.=$row['id_imagen'].'.png='.utf8_decode($row2['palabra']).';';
							$id_palabra=$row2['id_palabra'];
		...
		while ($row=mysql_fetch_array($result)) {	
					...
					if (mysql_num_rows($traducciones) > 0) {
						...
						while ($row2=mysql_fetch_array($traducciones)) {
							...
							if ($row2['traduccion']=='sin traduccion' || $row2['traduccion']=='Sin traducción') {				
								$palabras.='';
							} else {
		...
		while ($row=mysql_fetch_array($result)) {	
					...
					if (mysql_num_rows($result2) > 0) {
						...
						while ($row2=mysql_fetch_array($result2)) {
							...
							$palabras_castellano.=$row['id_imagen'].'.jpg='.utf8_decode($row2['palabra']).';';
							$id_palabra=$row2['id_palabra'];
		...
		while ($row=mysql_fetch_array($result)) {	
					...
					if (mysql_num_rows($result2) > 0) {
						...
						while ($row2=mysql_fetch_array($result2)) {
							...
							$palabras_castellano.=$row2['id_palabra'].'='.utf8_decode($row2['palabra']).'='.$row2['id_tipo_palabra'].';';
							$id_palabra=$row2['id_palabra'];
	...
	$xls->addRow(Array("ID imagen","Castellano","Ingles","Frances","Catalan","Italiano","Aleman","Portugues","Portugues Brasil"));
						...
						while ($row2=mysql_fetch_array($result2)) {
							...
							while ($row3=mysql_fetch_array($traducciones)) {
								...
								switch ($row3['id_idioma']) {
										...
										case 1:
										if ($row3['traduccion']!='sin traduccion' && $row3['traduccion']!='Sin traducción') {
											$palabras_ruso.=$utfConverter_ru->strToUtf8($row3['traduccion']).'='.$row2['id_tipo_palabra'].';';
										}
										break;
										...
										case 3:
										if ($row3['traduccion']!='sin traduccion' && $row3['traduccion']!='Sin traducción') {
											$palabras_arabe.=$utfConverter->strToUtf8($row3['traduccion']).'='.$row2['id_tipo_palabra'].';';
										} 
										break;
										...
										case 5:
										if ($row3['traduccion']!='sin traduccion' && $row3['traduccion']!='Sin traducción') {
											$palabras_bulgaro.=$utfConverter_ru->strToUtf8($row3['traduccion']).'='.$row2['id_tipo_palabra'].';';
										}
										break;
