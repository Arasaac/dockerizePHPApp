...
for ($idm=0;$idm<10;$idm++) {
	...
	//Si el contenido es "sin traduccion" no ejecuto el código y no genero el simbolo
	if ($contenido_traduccion[$y] != 'sin traduccion') { 
	...
	//***********************************************************
		...
		//***********************************************************
			...
			//***********************************************************
			} //Cierro el IF que comprueba que la traduccion no se "sin traduccion"
		//***********************************************************
