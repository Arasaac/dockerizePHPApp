...
$path = "../../importar/imagenes/byn/duplicadas/";
$dir = opendir($path);
while ($elemento = readdir($dir))
{
	if($elemento != "." && $elemento != ".."){ 
	   ...
	   if ($num_resultados > 0) { 
			...
			copy ("../../importar/imagenes/byn/duplicadas/".$elemento."","../../repositorio/originales/".$nueva_imagen."");
			unlink ("../../importar/imagenes/byn/duplicadas/".$elemento."");
