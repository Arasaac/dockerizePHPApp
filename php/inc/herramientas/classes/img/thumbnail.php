...
/* *********************************************************************************** */
	  ...
	  switch ($extension) { /* EN FUNCIÓN DE LA EXTENSIÓN DE LA IMAGEN..... */
		...
		if($resultado == FALSE && $di['id_tipo_imagen'] > 0){
			
			if (!file_exists('../../../../repositorio/thumbs/'.$di['id_tipo_imagen'].'/')) {
				mkdir('../../../../repositorio/thumbs/'.$di['id_tipo_imagen'].'/');
			}
			
			if (!file_exists('../../../../repositorio/thumbs/'.$di['id_tipo_imagen'].'/'.$tamaño_max.'/')) {
				mkdir('../../../..//repositorio/thumbs/'.$di['id_tipo_imagen'].'/'.$tamaño_max.'/');
			}
			
			if (!file_exists('../../../../repositorio/thumbs/'.$di['id_tipo_imagen'].'/'.$tamaño_max.'/'.$nombre_archivo[0].'/')) {
				mkdir('../../../../repositorio/thumbs/'.$di['id_tipo_imagen'].'/'.$tamaño_max.'/'.$nombre_archivo[0].'/');
			}
			
			imagejpeg($dest,'../../../../repositorio/thumbs/'.$di['id_tipo_imagen'].'/'.$tamaño_max.'/'.$nombre_archivo[0].'/'.$nombre_archivo.'.gif'); /* CREO LA IMAGEN */
		}
		...
		if($resultado == FALSE && $di['id_tipo_imagen'] > 0){
			...
			imagejpeg($dest,'../../../../repositorio/thumbs/'.$di['id_tipo_imagen'].'/'.$tamaño_max.'/'.$nombre_archivo[0].'/'.$nombre_archivo.'.jpg'); /* CREO LA IMAGEN */
		}
		...
		if($resultado == FALSE && $di['id_tipo_imagen'] > 0){
			...
			imagejpeg($dest,'../../../../repositorio/thumbs/'.$di['id_tipo_imagen'].'/'.$tamaño_max.'/'.$nombre_archivo[0].'/'.$nombre_archivo.'.jpeg'); /* CREO LA IMAGEN */
		...
		if($resultado == FALSE && $di['id_tipo_imagen'] > 0){
			...
			imagejpeg($dest,'../../../../repositorio/thumbs/'.$di['id_tipo_imagen'].'/'.$tamaño_max.'/'.$nombre_archivo[0].'/'.$nombre_archivo.'.png'); /* CREO LA IMAGEN */
		}
