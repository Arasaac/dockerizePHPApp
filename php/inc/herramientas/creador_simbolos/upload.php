...
if(move_uploaded_file($ftmp, $fname)){
	...
	images.innerHTML="<img src=\"../../../temp/<?=$oname?>\"><form id=\"img_subida\" name=\"img_subida\" method=\"post\" action=\"\"><input name=\"imagen_subida\" type=\"hidden\" id=\"imagen_subida\" value=\"<?=$oname?>\"/></form>";
	</script></head>
	</html>
	<?php
	exit();
