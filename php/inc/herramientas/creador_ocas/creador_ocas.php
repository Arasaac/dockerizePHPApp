...
<div id="mi_repositorio">
 <h4 style="text-transform:uppercase;"><?php echo $translate['juego_oca']; ?></h4>
...
<input name="seleccion_cesto" type="hidden" id="seleccion_cesto" size="100" />
        ...
        <fieldset>
                  ...
                  <p><?php echo $translate['borde_camino']; ?>:
                  ...
                  <p><?php echo $translate['borde_separador_celdas']; ?>:
                    <input name="color_borde_celdas" type="text" id="color_borde_celdas" value="CCCCCC"  size="1" maxlength="7" style="background-color:#CCCCCC; width:15px;" readonly="readonly" />
                    <a href="javascript:TCP.popup(document.forms['seleccion_simbolos'].elements['color_borde_celdas'])"><img width="15" height="15" border="0" alt="<?php echo $translate['seleccione_color']; ?>" title="<?php echo $translate['seleccione_color']; ?>" src="../../../images/colors.gif" /></a>&nbsp;<?php echo $translate['ancho_borde']; ?>:
                    <label>
        ...
        <fieldset>
          ...
          <label for="enunciado"><?php echo $translate['enunciado_ejercicio']; ?></label>
            <input name="enunciado" type="text" id="enunciado" value="<?php echo $translate['de_oca_a_oca']; ?>" size="70" />
          <p><?php echo $translate['texto']; ?>:
            ...
            <select name="fuente_texto2" size="1" id="fuente_texto2" class="fonty">
        ...
        <br />        
        <input name="crear" type="submit" value="<?php echo $translate['generar_tablero_oca']; ?>" style="font-size:24px;" onclick="seleccion_simbolos.action='generar_rtf_7.php'; return true;"/>
              </div> 
			</td>
        </tr>
        </table>
