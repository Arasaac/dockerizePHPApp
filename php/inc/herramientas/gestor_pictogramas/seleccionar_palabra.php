...
<input type="button" name="Submit2" value="Buscar" onclick="cargar_div2('listar_palabras_reducido.php','id_tipo='+document.vm_diccionario.tipo_palabra.value+'&letra='+document.vm_diccionario.letra.value+'','tabla_palabras');" /></td>
          </tr>
        </table>
<br /><br />
