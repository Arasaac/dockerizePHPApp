...
/* ******************************************************************************************* */ 	
		...
		$contar=$query->listar_paneles_por_palabra($letra,$id_usuario);
		$pegar=$query->listar_paneles_por_palabra_limit($letra,$id_usuario,$inicial,$cantidad);
	  ...
	  $color = 'tablaAlterno1';
		...
		?>
         <tr class="<?php echo $color; ?>" height="2%">
           <td width="14%" valign="middle"><span style="width:500px; height:300px;"> <a href="<?php echo $PHP_SELF ?>?id_panel=<?php echo $entrada['id_panel']; ?>" target="_self"/> <img src="../../../images/seleccionar.gif" alt="Seleccionar palabra" border="0" /> </a></span></td>
