...
<div id="cesto" style="display:<?php if (isset($_SESSION['cart']) && $_SESSION['cart'] !="") { echo 'block'; } else { echo 'none'; }?>;">
...
<div id="palabras" style="display:<?php if (isset($_SESSION['cart']) && $_SESSION['cart'] !="") { echo 'none'; } else { echo 'block'; }?>; text-align:left;">
