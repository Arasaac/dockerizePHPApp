...
<body onload="procesar('listar_plantillas.php','id=2','mis_selecciones'); procesar('mostrar_opciones_plantilla.php','desde=2','opciones'); procesar('mostrar_opciones_celda.php','desde=2','opciones_celda');">
<form action="generar_panel_rtf.php" method="post" enctype="multipart/form-data" name="generador_paneles" id="generador_paneles">
<div class="body_content" style="height:1120px;">
<link rel="STYLESHEET" type="text/css" href="../js/dhtmlxMenu/css/dhtmlXMenu.css">
    ...
    <div class="left" style="height:980px;">
      ...
      <div class="left_box">
       <br />
          <div id="b_tabbar" class="dhtmlxTabBar" imgpath="../js/dhtmlxTabbar/codebase/imgs/" style="width:100%; height:900px;"  skinColors="#FCFBFC,#F4F3EE" >
...
<div style="display:block; border:1px solid #CCCCCC; width:295px; margin-left:10px;">
  ...
  <tr>
    <td>  <div align="center">
      ...
      <div align="center"><div id="loading"><img src="../../../images/loading1.gif" alt="Cargando..." /></div><div id="clearCart"><a href="javascript:void(0);" onClick="generar_animacion(<?php echo $_SESSION['ID_USER']; ?>);">
        <input type="image" src="../../../images/print_me.jpg" alt="Imprimir" />
      </a></div>
        <br />
      </div> </td>
  </tr>
    ...
    <br />
    <div id="a_tabbar" class="dhtmlxTabBar" imgpath="../js/dhtmlxTabbar/codebase/imgs/" style="width:290px; height:860px; margin-left:10px;" skinColors="#FCFBFC,#F4F3EE" mode="right">
