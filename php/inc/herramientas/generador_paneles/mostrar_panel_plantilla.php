	...
	for ($p=1; $p<=$datos['n_paneles']; $p++){ // PANELES
		...
		$contenido='';
						...
						if ($datos['configuracion_celda']==1) {
							...
							<input type="hidden" name="ptc_'.$p.'_'.$f.'_'.$c.'" id="ptc_'.$p.'_'.$f.'_'.$c.'" value="2"/>
							<input type="hidden" name="ftc_'.$p.'_'.$f.'_'.$c.'" id="ftc_'.$p.'_'.$f.'_'.$c.'" value="Arial"/>';
								if ($f=='img') {
									$contenido.='<input type="hidden" name="sftc_'.$p.'_'.$f.'_'.$c.'" id="sftc_'.$p.'_'.$f.'_'.$c.'" value="9"/>';
								} else {
									$contenido.='<input type="hidden" name="sftc_'.$p.'_'.$f.'_'.$c.'" id="sftc_'.$p.'_'.$f.'_'.$c.'" value="18"/>';
								}
							$contenido.='<input type="hidden" name="mtc_'.$p.'_'.$f.'_'.$c.'" id="mtc_'.$p.'_'.$f.'_'.$c.'" value="0"/>
							<input type="hidden" name="tist_'.$p.'_'.$f.'_'.$c.'" id="tist_'.$p.'_'.$f.'_'.$c.'" value="'.$datos['img_size_no_text_cabecera'].'"/>
							<input type="hidden" name="tict_'.$p.'_'.$f.'_'.$c.'" id="tict_'.$p.'_'.$f.'_'.$c.'" value="'.$datos['img_size_with_text_cabecera'].'"/>';
