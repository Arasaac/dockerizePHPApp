...
<input type="button" name="Submit2" value="Buscar" onclick="cargar_div('gestionar_repositorio/listar_palabras_reducido.php','id_tipo='+document.vm_diccionario.tipo_palabra.value+'&letra='+document.vm_diccionario.letra.value+'&file_id=<?php echo $_GET['file_id']; ?>','tabla_palabras');" /></td>
          </tr>
        </table>
<hr />
</form>
