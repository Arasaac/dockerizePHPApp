	  ...
	  $color = 'tablaAlterno1';
		...
		?>
         <tr class="<?php echo $color; ?>" height="2%">
           <td width="8%" valign="top"><span style="width:500px; height:300px;"> <a href="javascript:void(0);" onclick="cargar_div('gestionar_repositorio/actualizar_palabra_asociada.php','id_palabra=<?php echo $entrada['id_palabra']; ?>&file_id=<?php echo $file_id; ?>','contenedor');" /> <img src="../../images/seleccionar.gif" alt="Seleccionar palabra" border="0" /> </a></span></td>
      ...
      <td><table width="100%" height="30" border="0" align="left" cellpadding="0" cellspacing="2">
       <tr class="textos">
         ...
         <td width="28%"  style="color:#A12B6F; font-family:Georgia, Times New Roman, Times, serif; font-size:12px; text-align:center;"><div align="center">
             ...
             <input type="button" name="Submit2" value="&lt; Anterior" onclick="cargar_div('listar_palabras_reducido.php','id_tipo='+document.vm_diccionario.tipo_palabra.value+'&amp;letra='+document.vm_diccionario.letra.value+'&amp;pg=<?php echo $url ?>','tabla_palabras');" />
         </div></td>
         ...
         <td width="26%"  style="color:#A12B6F; font-family:Georgia, Times New Roman, Times, serif; font-size:12px; text-align:center;"><div align="center">
             ...
             <input type="button" name="Submit2" value="Siguiente &gt;" onclick="cargar_div('listar_palabras_reducido.php','id_tipo='+document.vm_diccionario.tipo_palabra.value+'&amp;letra='+document.vm_diccionario.letra.value+'&amp;pg=<?php echo $url ?>','tabla_palabras');" />
         </div></td>
