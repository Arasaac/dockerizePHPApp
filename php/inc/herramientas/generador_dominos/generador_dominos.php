...
function contar(form) {
 ...
 if (cont < 6) {
	alert('<?php echo $translate['adverencia_domino']; ?>'); 
	return false;
 } else {
	 seleccion_simbolos.action='generar_domino.php';
	 form.submit();
	 return true;
 }
...
<div id="mi_repositorio">
 <div style="float:left; width:90%;"><h4 style="text-transform:uppercase;"><?php echo $translate['generador_dominos']; ?></h4></div>
...
<table width="100%" border="0">
  <tr>
    <td width="94%"><?php echo $translate['explicacion_domino_paso_1']; ?></td>
    <td width="6%">
...
<fieldset>
          ...
          <p>
            ...
            <select name="tipo_bingo" size="1" id="tipo_bingo">
              <option value="1"><?php echo $translate['pictograma_pictograma']; ?></option>
              <option value="2" selected="selected"><?php echo $translate['numero_pictograma']; ?></option>
              <option value="6"><?php echo $translate['numero_pictograma_2']; ?></option>
              <option value="3"><?php echo $translate['texto_pictograma']; ?></option>
              <option value="4"><?php echo $translate['mayusculas_minusculas']; ?></option>
              <option value="5"><?php echo $translate['minusculas_mayusculas']; ?></option>
            <option value="7"><?php echo $translate['tradicional']; ?></option>
            </select>
            </p>
