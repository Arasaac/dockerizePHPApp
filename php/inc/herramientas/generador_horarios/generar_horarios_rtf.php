<?php
session_start();
require('../classes/phprtflite.1.0.2/lib/PHPRtfLite.php');
...
$header->writeText(''.$translate['generador_horarios'].' ARASAAC v0.1', new PHPRtfLite_Font(6, 'Arial', '#999'), new PHPRtfLite_ParFormat('right'));
