          ...
          <tr valign="middle">
            <td><strong>Diccionario:
              ...
              <select name="tipo_palabra" class="textos" id="tipo_palabra" required="1" realname="Categor&iacute;a">
                <option value="<?php echo $_POST['tipo_palabra']; ?>"><?php echo $cat_palabra['tipo_palabra'] ?></option>
...
<input type="button" name="Submit2" value="Buscar" onclick="cargar_div('inc/gestion_imagenes/listar_palabras_reducido_para_modificar.php','id_tipo='+document.vm_diccionario.tipo_palabra.value+'&letra='+document.vm_diccionario.letra.value+'&id_imagen=<?php echo $_GET['id_imagen']; ?>','tabla_palabras');" /></td>
          </tr>
        </table>
<br /><br />
