   ...
   <tbody>
      ...
      <tr class="<?php echo $color; ?>">
        <td><span style="width:500px; height:300px;">
          <input type="button" name="Submit2" value="S" onclick="add_palabra('inc/gestion_imagenes/palabra_seleccionada.php','<?php echo $entrada['id_palabra']; ?>','selected_word'); Dialog.closeInfo();" />         </span></td>
   ...
   <table width="60%" height="30" border="0" align="center" cellpadding="0" cellspacing="2">
            <tr class="textos">
                <td width="9%" style="color:#A12B6F; font-family:Georgia, Times New Roman, Times, serif; font-size:12px; text-align:center;">
                  <input type="button" name="Submit" value="&lt;&lt;" onclick='cargar_div("inc/gestion_imagenes/listar_palabras_reducido.php","id_tipo="+document.vm_diccionario.tipo_palabra.value+"&letra="+document.vm_diccionario.letra.value+"&pg=0","tabla_palabras");'>              </td>
                <td width="28%"  style="color:#A12B6F; font-family:Georgia, Times New Roman, Times, serif; font-size:12px; text-align:center;"><div align="center"><?php if ($_POST['pg'] != 0) { 
                  ...
                  <input type="button" name="Submit" value="< Anterior" onclick='cargar_div("inc/gestion_imagenes/listar_palabras_reducido.php","id_tipo="+document.vm_diccionario.tipo_palabra.value+"&letra="+document.vm_diccionario.letra.value+"&pg=<?php echo $url ?>","tabla_palabras");'>
              </div></td>
              <td width="28%"  style="color:#A12B6F; font-family:Georgia, Times New Roman, Times, serif; font-size:12px; text-align:center;">&nbsp;</td>
                <td width="26%"  style="color:#A12B6F; font-family:Georgia, Times New Roman, Times, serif; font-size:12px; text-align:center;"><div align="center"><?php if ($_POST['pg'] < $pages) { 
                  ...
                  <input type="button" name="Submit" value="Siguiente >" onclick='cargar_div("inc/gestion_imagenes/listar_palabras_reducido.php","id_tipo="+document.vm_diccionario.tipo_palabra.value+"&letra="+document.vm_diccionario.letra.value+"&pg=<?php echo $url ?>","tabla_palabras");'>
              </div></td>
              <td width="9%"  style="color:#A12B6F; font-family:Georgia, Times New Roman, Times, serif; font-size:12px; text-align:center;"><input type="button" name="button" value="&gt;&gt;" onclick='cargar_div("inc/gestion_imagenes/listar_palabras_reducido.php","id_tipo="+document.vm_diccionario.tipo_palabra.value+"&letra="+document.vm_diccionario.letra.value+"&pg=<?php echo $pages; ?>","tabla_palabras");'></td>
            </tr>
</table>      
