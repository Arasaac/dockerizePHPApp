...
$id_imagen=$_POST['id'];
$row=$query->datos_imagen($_POST['id']);
...
if ($row['extension']=='flv') {
	$fsize = @filesize("../../repositorio/LSE_acepciones/".$row['imagen'])/1024;
...
<?php if ($row['extension']=='flv') { 
	echo '<object type="application/x-shockwave-flash" data="plugins/toobplayer/toobplayer_simple1.swf" style="outline: none;" width="260" height="275">
	...
	echo '<img src="classes/img/thumbnail.php?size=250&ruta=../../repositorio/originales/'.$row['imagen'].'&enc=0" border="0" alt="Mostrar informacion de la imagen"/>';
} ?>
			...
			<div class="right_articles">
			  <p><b>Peso: </b> <?php printf(" %.2f kB", $fsize);?><br>
			    <?php if ($row['extension'] !='flv') { echo '<b>Tama&ntilde;o: </b>'.$img_x.'x'.$img_y.'<br>'; } ?>
			...
			<div class="right_articles">
              ...
              <p><strong>Tipo Imagen </strong>
			    ...
			    <select name="id_tipo_imagen" id="id_tipo_imagen">
