...
<li style="min-width: 40%; max-width:50%;"> <a href="index.php" target="_self"><img src="images/arasaac_titulo_autismo.png" alt="<?php echo $translate['ir_pagina_inicio']; ?>" title="<?php echo $translate['ir_pagina_inicio']; ?>"  /></a></li> 
