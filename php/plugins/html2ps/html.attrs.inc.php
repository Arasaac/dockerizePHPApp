<?php
// $Header: /cvsroot/html2ps/html.attrs.inc.php,v 1.41 2005/10/19 17:31:23 Konstantin Exp $
...
function attr_table_border_before(&$root) {
  ...
  $border['left']['style']   = "/bs-solid";
  $border['right']['style']  = "/bs-solid";
  $border['top']['style']    = "/bs-solid";
  $border['bottom']['style'] = "/bs-solid";
