<?php
// $Header: /cvsroot/html2ps/css.inc.php,v 1.12 2005/10/06 03:55:16 Konstantin Exp $
...
function pop_css_defaults() {
  ...
  global $g_css_handlers;
  foreach (array_keys($g_css_handlers) as $key) {
...
class CSSProperty {
  ...
  function is_default($value) { return $this->default_value() === $value; }
