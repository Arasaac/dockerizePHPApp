<?php
// $Header: /cvsroot/html2ps/css.background.color.inc.php,v 1.10 2005/09/25 16:21:43 Konstantin Exp $
...
class CSSBackgroundColor extends CSSSubProperty {
  function default_value() {
    // Transparent color
    return new ColorPDF(array(0,0,0), true);
  }
  ...
  function parse($value) {
    ...
    foreach ($terms as $term) {
      ...
      if ($color != CSSBackgroundColor::default_value()) { 
