<?php
// $Header: /cvsroot/html2ps/box.table.cell.php,v 1.24 2005/10/15 10:47:14 Konstantin Exp $

class TableCellBoxPDF extends GenericContainerBoxPDF {
  var $colspan;
  var $rowspan;
  var $column;

  function &create($pdf, &$root) {
    $box =& new TableCellBoxPDF($pdf, $root);
    return $box;
  }

  function TableCellBoxPDF($pdf, &$root) {
    $this->colspan = 1;
    $this->rowspan = 1;
...
class FakeTableCellBoxPDF extends TableCellBoxPDF {
  var $colspan;
  var $rowspan;

  function FakeTableCellBoxPDF() {
