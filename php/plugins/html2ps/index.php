<?php
// $Header: /cvsroot/html2ps/index.php,v 1.4 2005/10/15 11:27:40 Konstantin Exp $
...
<span class="formw">
<input id="pageborder" class="nulinp" type="checkbox" name="pageborder" checked="checked" value="1"/>
</span>
</div>
...
<span class="formw">
<input class="nulinp" type="radio" id="ps" name="method" value="ps" checked="checked" />PostScript&nbsp;&nbsp;<label for="pdf">&nbsp;</label>
<!--<br /><input class="nulinp" type="radio" id="ps" name="method" value="fastps"/>PostScript (&quot;Compact&quot)-->
<br /><input class="nulinp" type="radio" id="pdf" name="method" value="ps2pdf" />PDF (GhostScript)
<br /><input class="nulinp" type="radio" id="pdf" name="method" value="pdflib" />PDF (PDFLIB)
<br /><input class="nulinp" type="radio" id="pdf" name="method" value="fpdf" />PDF (FPDF)
</span>
</div>
...
<div class="form-row">
<label class="hand" for="compr"><span class="labl">Compatibility</span></label>
<span class="formw">
<input class="nulinp" type="radio" id="compr" name="compress" value="1" checked="checked" />GhostScript/GSView (compressed postscript)<label for="compr1">&nbsp;&nbsp;</label><br />
<input class="nulinp" type="radio" id="compr1" name="compress" value="0" />Adobe Distiller (uncompressed postscript)<br/>
</span>
</div>
...
<!--
<div class="form-row">
<label class="hand" for="compr"><span class="labl">HTML-to-XHTML conversion</span></label>
<span class="formw">
<input class="nulinp" type="checkbox" id="html2xhtml" name="html2xhtml" value="1"/>Do not use conversion, input is valid XHTML<br/>
</span>
</div>
-->
