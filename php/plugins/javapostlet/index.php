...
echo '<html>
	...
	<body>
		<applet name="postlet" code="Main.class" archive="postlet.jar" width="100%" height="95%" mayscript>
			...
			<param name = "destination"		value = "http://catedu.es/arasaac/plugins/javapostlet/upload.php" />
			...
			<param name = "fileextensions" value = "Archivos,zip,doc,docx,pdf,tco,odt,rar,notebook,ppt,pps,pptx,ppsx,odp,gif,swf" />
			<param name = "endpage" value = "http://catedu.es/arasaac/plugins/javapostlet/index.php" />
