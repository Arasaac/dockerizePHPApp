...
echo '<html>
	...
	<body>
		<applet name="postlet" code="Main.class" archive="postlet.jar" width="100%" height="95%" mayscript>
			...
			<param name = "destination"		value = "http://catedu.es/arasaac/plugins/javapostlet/upload_software.php" />
			...
			<param name = "endpage" value = "http://catedu.es/arasaac/plugins/javapostlet/index_software.php" />
