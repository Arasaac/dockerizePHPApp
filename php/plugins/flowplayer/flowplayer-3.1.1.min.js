...
(function(){
			...
			function n(s){
							...
							if(q!=-1)
								{
								var p=s.substring(0,q)||"*";var o=s.substring(q+1,s.length);
								var r=[];m(document.getElementsByTagName(p),function()
																				{
			...
			var h=function(t,r,s){
								...
								i(this,{
									onCuepoint:function(x,w)
										...
										,update:function(w)
											...
											i(x,w,true)},_fireEvent:function(v,y,w,A){
												if(v=="onLoad")
													{
													m(p,function(B,C)
														{
								...
								if(t.onCuepoint)
									...
									delete t.onCuepoint}m(t,function(v,w){if(typeof w=="function"){j(u,v,w);delete t[v]}});
									if(r==-1)
											{
																																	...
																																	return o},css:function(w,x){
																																							if(x!==undefined)
																																									...
																																									return o
																																												...
																																												{
																																												this.display="block";q._api().fp_showPlugin(p);
																																												return o
																																												},hide:function(){
																																																this.display="none";
