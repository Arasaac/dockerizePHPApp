...
<div id="barra_opciones_superior"><a href="materiales.php?<?php echo $cadena_url_buscador ?>buscador=1"><?php echo $translate['busqueda_basica']; ?></a> | <a href="materiales.php?<?php echo $cadena_url_buscador ?>buscador=2"><?php echo $translate['busqueda_avanzada']; ?></a> | <a href="rss/subscripcion.php?t=3" target="_blank"><img src="images/rss.png" alt="<?php echo $translate['subscribirse_catalogo_materiales']; ?>" title="<?php echo $translate['subscribirse_catalogo_materiales']; ?>" /></a>&nbsp;<a href="rss/subscripcion.php?t=3" target="_blank"><?php echo $translate['subscribirse']; ?></a>&nbsp;
