...
?>
    <title>ARASAAC: <?php echo $translate['subscripciones_arasaac']; ?></title>
...
<div class="body_content"> 
     ...
     <br /> <h4><?php echo $translate['subscripciones_arasaac']; ?>:&nbsp;<?php echo $translate ['recibe_novedades_arasaac']; ?></h4><br />
      <p><?php echo $translate['explicacion_rss']; ?></p>
		<div id="principal">
            ...
            <p>&nbsp;</p>
            <div style="background-color:#CCCCCC; color:#333333; padding:5px; font-size:14px;"><strong><?php echo $translate['ejemplos_de_uso']; ?></strong></div>
            <div style="border:1px solid #CCCCCC;">
              <ul style=" list-style:none; line-height:30px;">
                <li><img src="images/rss-icono.gif" border="0" alt="<?php echo $translate['canal']; ?>: <?php echo $translate['ultimos_ejemplos_de_uso']; ?> ARASAAC" title="<?php echo $translate['canal']; ?>: <?php echo $translate['ultimos_ejemplos_de_uso']; ?> ARASAAC">&nbsp;&nbsp;<strong><?php echo $translate['ultimos_ejemplos_de_uso']; ?>:&nbsp;&nbsp;</strong> <a title="<?php echo $translate['url_otros_lectores']; ?>:" href="http://catedu.es/arasaac/rss/subscripcion.php?t=9" target="_blank"><img src="images/feed.png" border="0" alt="RSS" title="RSS"></a> | <a title="<?php echo $translate['google_personalizado']; ?>" href="http://www.google.com/ig/add?feedurl=http://catedu.es/arasaac/rss/subscripcion.php?t=9" target="_blank"><img src="images/google.jpg" border="0" alt="<?php echo $translate['google_personalizado']; ?>" title="<?php echo $translate['google_personalizado']; ?>"></a> | <a title="BlogLines" href="http://www.bloglines.com/sub/http://catedu.es/arasaac/rss/subscripcion.php?t=9" target="_blank"><img src="images/bloglines.gif" border="0" alt="Bloglines" title="Bloglines"></a> | <a title="Netvibes" href="http://www.netvibes.com/subscribe.php?url=http://catedu.es/arasaac/rss/subscripcion.php?t=9" target="_blank"><img src="images/netvibes.png" border="0" alt="Netvibes" title="Netvibes"></a> | <a title="Windows Live" href="http://www.live.com/Default.aspx?add=http://catedu.es/arasaac/rss/subscripcion.php?t=9" target="_blank"><img src="images/windows-live.gif" border="0" alt="Windows Live" title="Windows Live"></a> | <a title="Yahoo" href="http://add.my.yahoo.com/content?url=http://catedu.es/arasaac/rss/subscripcion.php?t=9" target="_blank"><img src="images/mi_yahoo.gif" border="0" alt="Yahoo" title="Yahoo"></a> </li>
                <li></li>
              </ul>
            </div>
            
            <p>&nbsp;</p>
            <div style="background-color:#CCCCCC; color:#333333; padding:5px; font-size:14px;"><strong><?php echo $translate['software_minusculas']; ?></strong></div>
            <div style="border:1px solid #CCCCCC;">
              <ul style=" list-style:none; line-height:30px;">
                <li><img src="images/rss-icono.gif" border="0" alt="<?php echo $translate['canal']; ?>: <?php echo $translate['ultimas_fichas_software']; ?> ARASAAC" title="<?php echo $translate['canal']; ?>: <?php echo $translate['ultimas_fichas_software']; ?> ARASAAC">&nbsp;&nbsp;<strong><?php echo $translate['ultimas_fichas_software']; ?>:&nbsp;&nbsp;</strong> <a title="<?php echo $translate['url_otros_lectores']; ?>:" href="http://catedu.es/arasaac/rss/subscripcion.php?t=8" target="_blank"><img src="images/feed.png" border="0" alt="RSS" title="RSS"></a> | <a title="<?php echo $translate['google_personalizado']; ?>" href="http://www.google.com/ig/add?feedurl=http://catedu.es/arasaac/rss/subscripcion.php?t=8" target="_blank"><img src="images/google.jpg" border="0" alt="<?php echo $translate['google_personalizado']; ?>" title="<?php echo $translate['google_personalizado']; ?>"></a> | <a title="BlogLines" href="http://www.bloglines.com/sub/http://catedu.es/arasaac/rss/subscripcion.php?t=8" target="_blank"><img src="images/bloglines.gif" border="0" alt="Bloglines" title="Bloglines"></a> | <a title="Netvibes" href="http://www.netvibes.com/subscribe.php?url=http://catedu.es/arasaac/rss/subscripcion.php?t=8" target="_blank"><img src="images/netvibes.png" border="0" alt="Netvibes" title="Netvibes"></a> | <a title="Windows Live" href="http://www.live.com/Default.aspx?add=http://catedu.es/arasaac/rss/subscripcion.php?t=8" target="_blank"><img src="images/windows-live.gif" border="0" alt="Windows Live" title="Windows Live"></a> | <a title="Yahoo" href="http://add.my.yahoo.com/content?url=http://catedu.es/arasaac/rss/subscripcion.php?t=8" target="_blank"><img src="images/mi_yahoo.gif" border="0" alt="Yahoo" title="Yahoo"></a> </li>
                <li></li>
              </ul>
            </div>
