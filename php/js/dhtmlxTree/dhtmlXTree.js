 ...
 else
{
 ...
 dhtmlXTreeObject.prototype._correctLine=function(itemObject){var sNode=itemObject.parentObject;
 try{
 if(sNode)
 ...
 if((targetObject.XMLload==0)&&(this.XMLsource))
{
 ...
 if((framesMove)||(oldTree.dpcpy))itemObject=this._recreateBranch(itemObject,targetObject,beforeNode);
 else
{
