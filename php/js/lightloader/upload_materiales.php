...
<html>
<head>
<title>Subir materriales a la carpeta temporal</title>
...
<div style="width: 520px; margin: 2em auto;">
 <h1 style="font-size: 100%;">Subir archivos a la carpeta temporal:</h1>
  <div style="width: 500px; border: 1px solid #669900; padding: .5em">
  ...
  <div class="mainDiv" style="width: 40em; border: 0;"></div>
</div>
</body>
</html>
