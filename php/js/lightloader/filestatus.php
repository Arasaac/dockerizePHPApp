...
$moveToFolder = "../../zona_descargas/materiales/temp"; //Where the files will be moved upon upload, leave blank if you want it to be the same as $tempFolder.
...
if (in_array($temp, $bad_files) && !file_exists($error_file)) {
  ...
  $request->error_msg = 'Extensión no permitida: ' . $temp . '.  Trate de subir otro archivo.';
