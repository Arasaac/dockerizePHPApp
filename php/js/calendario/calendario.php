...
////////////////////////////////////////////////////////////////////////////////////////////////////////////
function escribe_formulario_fecha_vacio($nombrecampo,$nombreformulario,$valor){
	global $raiz;
	echo '
	<INPUT name="'.$nombrecampo.'" maxlength="10" size="13" value="'.$valor.'">
	<input type="button" value="Elegir fecha" onClick="javascript:muestraCalendario(\''. $raiz.'\',\''. $nombreformulario .'\',\''.$nombrecampo.'\')">';	
}
?>