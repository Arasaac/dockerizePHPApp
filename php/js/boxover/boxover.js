...
function defHdrStyle() {
	...
	dvHdr.style.width='280px';
	dvHdr.style.fontFamily='arial';
	dvHdr.style.border='1px solid #D2579E';
	dvHdr.style.padding='3';
	dvHdr.style.fontSize='11';
	dvHdr.style.color='#D2579E';
	dvHdr.style.background='#F7D4E8';
	dvHdr.style.filter='alpha(opacity=95)'; // IE
	dvHdr.style.opacity='0.95'; // Firefox
}

function defBdyStyle() {
	dvBdy.style.borderBottom='1px solid #D2579E';
	dvBdy.style.borderLeft='1px solid #D2579E';
	dvBdy.style.borderRight='1px solid #D2579E';
	...
	dvBdy.style.opacity='0.95'; // Firefox
}
