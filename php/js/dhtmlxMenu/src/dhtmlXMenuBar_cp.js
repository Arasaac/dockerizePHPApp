...
dhtmlXContextMenuObject.prototype.setContextZone=function(htmlObject,zoneId){
	...
	htmlObject.onmousedown= function(e){this.selfobj._contextStart(this,e)};//nb
...
dhtmlXContextMenuObject.prototype._contextStart=function(obj,e){
	...
	if(e.screenY-winScreenTop+a.offsetHeight-window.document.body.scrollTop > window.document.body.clientHeight){//-e.offsetY
    ...
    {
	a.style.top = e.screenY-winScreenTop-corrector[1];//-e.offsetY
	a.style.left = e.screenX-winScreenLeft+corrector[0];//-e.offsetX
    }
