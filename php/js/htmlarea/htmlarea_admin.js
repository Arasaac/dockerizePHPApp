...
HTMLArea.Config = function () {
	...
	this.toolbar = [
		 ...
		 [ "fontname", "space",
		  "fontsize", "space",
		  "separator", "bold", "italic", "underline" , "separator", "forecolor", "hilitecolor"],

		[ "justifyleft", "justifycenter", "justifyright", "justifyfull", "strikethrough", "separator", "orderedlist", 
		 "unorderedlist", "outdent", "indent", "inserthorizontalrule", "createlink", "inserttable", "insertmp3", "subscript", 
		 "superscript", "separator", "copy", "cut", "paste","htmlmode"]
	...
	this.btnList = {
		...
		insertmp3: [ "Insertar archivo de podcast", "icon_mp3.gif", false, function(e) {e.execCommand("insertmp3");} ],
		htmlmode: [ "Toggle HTML Source", "blank.gif", true, function(e) {e.execCommand("htmlmode");} ],
...
// Called when the user clicks the Insert MP3
HTMLArea.prototype._insertMp3 = function() {
	var sel = this._getSelection();
	var range = this._createRange(sel);
	var editor = this;	// for nested functions
	this._popupDialog("insert_mp3.php?id_blog="+_editor_id_blog+"", function(param) {
		if (!param) {	// user must have pressed Cancel
			return false;
		}
		var doc = editor._doc;
		...
		for (var field in param) {
			...
			switch (field) {
			    case "f_rows"   : var html = value; break;
			}
		}

		table.innerHTML = "[podcast]"+html+"[/podcast]";
...
HTMLArea.prototype.execCommand = function(cmdID, UI, param) {
	...
	switch (cmdID) {
		...
		case "insertmp3": this._insertMp3(); break;
