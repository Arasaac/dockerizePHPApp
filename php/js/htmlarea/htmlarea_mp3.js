...
HTMLArea.Config = function () {
	...
	this.btnList = {
		...
		insertimage: [ "Insert/Modify Image", "ed_image.gif", false, function(e) {e.execCommand("insertmp3");} ],
...
HTMLArea.prototype._insertMp3 = function() {
	...
	var range = this._createRange(sel);
	var editor = this;	// for nested functions
	this._popupDialog("insert_mp3.html", function(param) {
		if (!param) {	// user must have pressed Cancel
			return false;
		}
		var doc = editor._doc;
