...
//	win = new Window('dialog3', {className: "alphacube", title: "Cesto de Símbolos", 
//								  top:10, right:100, width:300, height:500, 
//								  closable: false, url: "ventana_cesto.php", showEffectOptions: {duration:3}})
//	win.toFront();
...
//
//
//function mostrar_ventana_div() {
//  contentWin2 = new Window('cesto_de_simbolos', {className: "alphacube", title: "Mi Cesto", closable: false, resizable: false, hideEffect:Element.hide,  showEffect:Element.show, minWidth: 10})
//  contentWin2.setContent('cesto_simbolos', true, true);
//  contentWin2.setLocation(50, 200);
//  contentWin2.setSize(300, 500);
//  contentWin2.toFront();
//  contentWin2.setDestroyOnClose();
//  contentWin2.show();
//  contentWin2.minimize();
//  
//    // Set up a windows observer, check ou debug window to get messages
//  myObserver = {
//    onDestroy: function(eventName, win) {
//      if (win == contentWin2) {
//        $('container').appendChild($('cesto_simbolos'));
//        contentWin = null;
...
/* *************************************************** */
	...
	function cargar_menu_categorias(){
		tree=new dhtmlXTreeObject("treeboxbox_tree","100%","100%",0);
		tree.setImagePath("js/dhtmlxTree/imgs/");
		tree.loadXML("inc/public/tree_categorias.php");
...
//function cargar_pag_principal(page,param,div){
//
//		if(document.all)
//		{
//			//Internet Explorer
