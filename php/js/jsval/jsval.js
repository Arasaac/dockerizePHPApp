...
function _jsVal_Language() {
    this.err_form = "Por favor, rellene correctamente los siguientes campos:\n\n";
    this.err_select = "Por favor, seleccione un valor correcto para el campo: \"%FIELDNAME%\"";
    this.err_enter = "Por favor, introduzca un valor correcto para el campo: \"%FIELDNAME%\"";
};
