...
?>
    <title>ARASAAC: <?php echo $translate['lse']; ?>-><?php echo $translate['sistemas_educativos']; ?></title>
...
<div class="body_content"> 
	  ...
	  <div class="header">
		...
		<?php echo '<h4>'.$translate['lse'].'->'.$translate['sistemas_educativos'].'</h4>'; ?>
		<div id="principal">
            <div id="marco"><?php echo $translate['biblioteca_signos']; ?></div>
		  	<?php echo $translate['lse_sistemas_educativos']; ?>	     
		</div>
