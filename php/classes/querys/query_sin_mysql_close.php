...
//*********************************************************//
	...
	function ultimas_noticias_publicadas($limit) {
		...
		ORDER BY noticias.fecha_modificacion desc
		LIMIT 0,$limit";
...
function listado_temas() {
		...
		$query = "SELECT * FROM temas ORDER BY id_tema";
...
function listado_subtemas_completo() {
		...
		$query = "SELECT * FROM subtemas ORDER BY id_subtema";
...
//******************************************************************************//
	function actualizar_imagen($id_imagen,$id_tipo_imagen,$estado,$registrado,$id_licencia,$id_autor,$tags) {
...
// 							AÑADIR NUEVA IMAGEN                        //
//******************************************************************************//
	function add_new_picture($id_usuario,$id_tipo_imagen,$imagen,$id_palabra,$estado,$registrado,$id_autor,$id_licencia,$tags) {
		$timestamp=time();
		$fecha=date("Y-m-d H:i:s",$timestamp);
		$fecha_modificacion=date("Y-m-d H:i:s",$timestamp);
		...
		$connection = mysql_connect($this->HOST, $this->USERNAME, $this->PASSWORD);
		$SelectedDB = mysql_select_db($this->DBNAME);
		$ssql = "INSERT INTO imagenes(id_colaborador,id_tipo_imagen,fecha_creacion, ultima_modificacion, estado, registrado,id_autor,id_licencia,tags_imagen) 
			VALUES ('$id_usuario', '$id_tipo_imagen', '$fecha', '$fecha', '$estado','$registrado','$id_autor','$id_licencia','$tags')";
