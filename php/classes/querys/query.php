...
//******************************************************************************//
	...
	function actualizar_definicion_traduccion($key,$contenido,$id_idioma) {
		...
		$this->actualizar_definicion_traduccion_idioma($key,$contenido,$id_idioma);
	}
	
	function actualizar_definicion_traduccion_idioma($key,$contenido,$id_idioma) {

		$UpdateRecords = "UPDATE traducciones_".$id_idioma." SET definicion_traduccion='".addslashes($contenido)."' WHERE id_traduccion='".$key."'";
        $connection = mysql_connect($this->HOST, $this->USERNAME, $this->PASSWORD);
		$SelectedDB = mysql_select_db($this->DBNAME);
		$result = mysql_query($UpdateRecords);
	}
	
	function actualizar_estado_definicion_traduccion($key,$estado,$id_idioma) {
		
		$this->actualizar_estado_definicion_traduccion_idioma($key,$estado,$id_idioma);
	...
	function actualizar_estado_definicion_traduccion_idioma($key,$estado,$id_idioma) {

		$UpdateRecords = "UPDATE traducciones_".$id_idioma." SET estado_definicion_traduccion='$estado' WHERE id_traduccion='$key'";
        $connection = mysql_connect($this->HOST, $this->USERNAME, $this->PASSWORD);
		$SelectedDB = mysql_select_db($this->DBNAME);
		$result = mysql_query($UpdateRecords);
		mysql_close($connection);
	...
	function datos_traduccion($id_traduccion,$id_idioma) {
		
		$query = "SELECT *
		FROM traducciones_".$id_idioma."
...
//  LISTAR ULTIMOS SIMBOLOS PREDEFINIDOS A�ADIDOS            //
//*********************************************************//
...
//   LISTAR ULTIMOS SIMBOLOS A�ADIDOS  (solo la imagen)          //
//*********************************************************//
...
//   FUNCION COMPROBAR SI EXISTE VIDEO LSE - REVISADA     //
//*********************************************************//

	function comprobar_si_existe_ya_video_lse_acepcion($id_palabra) {
		$query = "SELECT palabra_imagen.id_palabra,palabra_imagen.id_imagen
		imagenes_11.id_imagen,imagenes_11.id_colaborador,
		imagenes_11.imagen,imagenes_11.extension,imagenes_11.id_tipo_imagen,
		imagenes_11.estado,imagenes_11.registrado,
		imagenes_11.id_licencia,imagenes_11.id_autor,
		imagenes_11.tags_imagen,imagenes_11.tipo_pictograma,
		imagenes_11.validos_senyalectica,
		imagenes_11.original_filename
		FROM palabra_imagen, imagenes
		WHERE palabra_imagen.id_palabra='$id_palabra'
		AND palabra_imagen.id_imagen=imagenes_11.id_imagen
		AND imagenes_11.id_tipo_imagen=11";
...
//       FUNCION COMPROBAR SI EXISTE IMAGEN LSE - MODIFICADA   //
//***********************************************************************//

	function comprobar_si_existe_ya_imagen_lse_acepcion($id_palabra) {
		$query = "SELECT palabra_imagen.id_palabra,palabra_imagen.id_imagen, 
		imagenes_12.id_imagen,imagenes_12.id_colaborador,
		imagenes_12.imagen,imagenes_12.extension,imagenes_12.id_tipo_imagen,
		imagenes_12.estado,imagenes_12.registrado,imagenes_12.id_licencia,
		imagenes_12.id_autor,imagenes_12.tags_imagen,
		imagenes_12.tipo_pictograma,imagenes_12.validos_senyalectica,
		imagenes_12.original_filename
		FROM palabra_imagen, imagenes
		WHERE palabra_imagen.id_palabra='$id_palabra'
		AND palabra_imagen.id_imagen=imagenes_12.id_imagen
		AND imagenes_12.id_tipo_imagen=12";
...
//   LISTAR IMAGENES ORGINALES PARA EXPORTAR - MODIFICADA    //
//*********************************************************//
function listar_imagenes_originales_para_exportar($id_tipo_imagen) {

		$query = "SELECT palabra_imagen.id_palabra,palabra_imagen.id_imagen 
		imagenes_".$id_tipo_imagen.".id_imagen,imagenes_".$id_tipo_imagen.".id_colaborador,
		imagenes_".$id_tipo_imagen.".imagen,imagenes_".$id_tipo_imagen.".extension,
		imagenes_".$id_tipo_imagen.".id_tipo_imagen,
		imagenes_".$id_tipo_imagen.".estado,imagenes_".$id_tipo_imagen.".registrado,
		imagenes_".$id_tipo_imagen.".id_licencia,
		imagenes_".$id_tipo_imagen.".id_autor,imagenes_".$id_tipo_imagen.".tags_imagen,
		imagenes_".$id_tipo_imagen.".tipo_pictograma,imagenes_".$id_tipo_imagen.".validos_senyalectica,
		imagenes_".$id_tipo_imagen.".original_filename,
		palabras.*
		FROM palabra_imagen, imagenes_".$id_tipo_imagen.", palabras
		WHERE imagenes_".$id_tipo_imagen.".estado=1
		AND palabra_imagen.id_palabra=palabras.id_palabra
		AND palabra_imagen.id_imagen=imagenes_".$id_tipo_imagen.".id_imagen
		AND imagenes_".$id_tipo_imagen.".id_tipo_imagen='$id_tipo_imagen'";
...
//   LISTAR IMAGENES ORGINALES PARA EXPORTAR CON LIMITE - MODIFICADA  //
//*******************************************************************//
function listar_imagenes_orginales_para_exportar_con_limite($id_tipo_imagen,$inicio,$fin) {
		...
		imagenes_".$id_tipo_imagen.".id_licencia,
		imagenes_".$id_tipo_imagen.".id_autor,imagenes_".$id_tipo_imagen.".tags_imagen,
		imagenes_".$id_tipo_imagen.".tipo_pictograma,
		imagenes_".$id_tipo_imagen.".validos_senyalectica,imagenes_".$id_tipo_imagen.".original_filename,
		palabras.*
		FROM palabra_imagen, imagenes_".$id_tipo_imagen.", palabras
		WHERE imagenes_".$id_tipo_imagen.".estado=1
		AND palabra_imagen.id_palabra=palabras.id_palabra
		AND palabra_imagen.id_imagen=imagenes_".$id_tipo_imagen.".id_imagen
		AND imagenes_".$id_tipo_imagen.".id_tipo_imagen='$id_tipo_imagen'
		AND imagenes_".$id_tipo_imagen.".id_imagen > $inicio
		AND imagenes_".$id_tipo_imagen.".id_imagen < $fin";
...
//   LISTAR ULTIMAS IMAGENES A�ADIDAS  (solo la imagen)          //
//*********************************************************//

	function listar_imagenes($registrado,$id_tipo,$letra,$filtrado,$orden,$id_subtema) {
	
		if ($registrado==false) {
			$mostrar_registradas="AND imagenes_2.registrado=0";
		}
		...
		if ($letra=="") { $sql_letra=''; } 
		else { $sql_letra="AND palabras.palabra LIKE _utf8'$letra%%' COLLATE utf8_general_ci"; }
		
		if ($filtrado==1) { $sql_filtrado='imagenes_2.ultima_modificacion'; } 
		elseif ($filtrado==2) { $sql_filtrado='palabras.palabra'; }
		
		$query = "SELECT DISTINCT 
		palabra_imagen.id_palabra,
		palabra_imagen.id_imagen, 
		imagenes_2.id_imagen,
		imagenes_2.id_colaborador,
		imagenes_2.imagen,
		imagenes_2.extension,
		imagenes_2.id_tipo_imagen,
		imagenes_2.estado,
		imagenes_2.registrado,
		imagenes_2.id_licencia,
		imagenes_2.id_autor,
		imagenes_2.tags_imagen,
		imagenes_2.tipo_pictograma,
		imagenes_2.validos_senyalectica,
		imagenes_2.original_filename,
		palabras.* $subtema_tabla
		FROM palabra_imagen, imagenes_2, palabras $subtema_tabla_from
		WHERE imagenes_2.estado=1
		AND palabras.id_palabra=palabra_imagen.id_palabra
		$sql_letra
		$sql_tipo
		$sql_subtema
		AND palabra_imagen.id_imagen=imagenes_2.id_imagen
		$mostrar_registradas
...
//*********************************************************//
	...
	function listar_cliparts($registrado,$id_tipo,$letra,$filtrado,$orden,$id_subtema) {
		...
		if ($registrado==false) {
			$mostrar_registradas="AND imagenes_9.registrado=0";
		}
		...
		if ($filtrado==1) { $sql_filtrado='imagenes_9.ultima_modificacion'; } 
		elseif ($filtrado==2) { $sql_filtrado='palabras.palabra'; }
		
		$query = "SELECT DISTINCT 
		palabra_imagen.id_palabra,
		palabra_imagen.id_imagen,
		imagenes_9.id_imagen,
		imagenes_9.id_colaborador,
		imagenes_9.imagen,
		imagenes_9.extension,
		imagenes_9.id_tipo_imagen,
		imagenes_9.estado,
		imagenes_9.registrado,
		imagenes_9.id_licencia,
		imagenes_9.id_autor,
		imagenes_9.tags_imagen,
		imagenes_9.tipo_pictograma,
		imagenes_9.validos_senyalectica,
		imagenes_9.original_filename, 
		palabras.* $subtema_tabla
		FROM palabra_imagen, imagenes_9, palabras $subtema_tabla_from
		WHERE imagenes_9.estado=1
		AND palabras.id_palabra=palabra_imagen.id_palabra
		$sql_letra
		$sql_tipo
		$sql_subtema
		AND palabra_imagen.id_imagen=imagenes_9.id_imagen
		$mostrar_registradas
		ORDER BY $sql_filtrado $orden";
...
//*********************************************************//
	...
	function listar_pictogramas_byn($registrado,$id_tipo,$letra,$filtrado,$orden,$id_subtema) {
		...
		if ($registrado==false) {
			$mostrar_registradas="AND imagenes_5.registrado=0";
		}
		...
		if ($filtrado==1) { $sql_filtrado='imagenes_5.ultima_modificacion'; } 
		elseif ($filtrado==2) { $sql_filtrado='palabras.palabra'; }
		
		$query = "SELECT DISTINCT 
		palabra_imagen.id_palabra,
		palabra_imagen.id_imagen, 
		imagenes_5.id_imagen,
		imagenes_5.id_colaborador,
		imagenes_5.imagen,
		imagenes_5.extension,
		imagenes_5.id_tipo_imagen,
		imagenes_5.estado,
		imagenes_5.registrado,
		imagenes_5.id_licencia,
		imagenes_5.id_autor,
		imagenes_5.tags_imagen,
		imagenes_5.tipo_pictograma,
		imagenes_5.validos_senyalectica,
		imagenes_5.original_filename,
		palabras.* $subtema_tabla
		FROM palabra_imagen, imagenes_5, palabras $subtema_tabla_from
		WHERE imagenes_5.estado=1
		AND palabras.id_palabra=palabra_imagen.id_palabra
		$sql_letra
		$sql_tipo
		$sql_subtema
		AND palabra_imagen.id_imagen=imagenes_5.id_imagen
		$mostrar_registradas
		ORDER BY $sql_filtrado $orden";
...
//   LISTAR ULTIMOS PICTOGRAMAS COLOR A�ADIDOS         //
//*********************************************************//

	function listar_pictogramas_color($registrado,$id_tipo,$letra,$filtrado,$orden,$id_subtema) {
	
		if ($registrado==false) {
			$mostrar_registradas="AND imagenes_10.registrado=0";
		}
		...
		if ($filtrado==1) { $sql_filtrado='imagenes_10.ultima_modificacion'; } 
		elseif ($filtrado==2) { $sql_filtrado='palabras.palabra'; }
		
		$query = "SELECT DISTINCT 
		palabra_imagen.id_palabra,
		palabra_imagen.id_imagen, 
		imagenes_10.id_imagen,
		imagenes_10.id_colaborador,
		imagenes_10.imagen,
		imagenes_10.extension,
		imagenes_10.id_tipo_imagen,
		imagenes_10.estado,
		imagenes_10.registrado,
		imagenes_10.id_licencia,
		imagenes_10.id_autor,
		imagenes_10.tags_imagen,
		imagenes_10.tipo_pictograma,
		imagenes_10.validos_senyalectica,
		imagenes_10.original_filename,
		palabras.* $subtema_tabla
		FROM palabra_imagen, imagenes_10, palabras $subtema_tabla_from
		WHERE imagenes_10.estado=1
		AND palabras.id_palabra=palabra_imagen.id_palabra
		$sql_letra
		$sql_tipo
		$sql_subtema	
		AND palabra_imagen.id_imagen=imagenes_10.id_imagen
		$mostrar_registradas
		ORDER BY $sql_filtrado $orden";
...
//   LISTAR ULTIMOS PICTOGRAMAS COLOR A�ADIDOS LIMIT          //
//*********************************************************//
...
//*********************************************************//
	...
	function listar_originales($registrado,$id_tipo,$letra,$filtrado,$orden,$id_subtema,$id_tipo_pictograma,$sql,$txt_locate) {
		...
		if ($registrado==false) {
			$mostrar_registradas="AND imagenes_".$id_tipo_pictograma.".registrado=0";
		}
		...
		if ($letra=="") { $sql_letra=''; } 
			...
			switch ($txt_locate) { 
				...
				case 1:
				$sql_letra="AND palabras.palabra LIKE _utf8'$letra%%' COLLATE utf8_general_ci";
				break;
		...
		if ($filtrado==1) { $sql_filtrado='imagenes_'.$id_tipo_pictograma.'.ultima_modificacion'; } 
		elseif ($filtrado==2) { $sql_filtrado='palabras.palabra'; }
		
		$query = "SELECT COUNT(*)
		FROM palabra_imagen, imagenes_".$id_tipo_pictograma.", palabras $subtema_tabla_from
		WHERE imagenes_".$id_tipo_pictograma.".estado=1
		AND palabras.id_palabra=palabra_imagen.id_palabra
		$sql_letra
		$sql_tipo
		$sql_subtema	
		AND palabra_imagen.id_imagen=imagenes_".$id_tipo_pictograma.".id_imagen
		$mostrar_registradas
		ORDER BY $sql_filtrado $orden";
...
//*********************************************************//
	...
	function listar_originales_limit($registrado,$inicial,$cantidad,$id_tipo,$letra,$filtrado,$orden,$id_subtema,$id_tipo_pictograma,$sql,$txt_locate) {
		...
		$query = "SELECT DISTINCT 
		imagenes_".$id_tipo_pictograma.".id_imagen,
		imagenes_".$id_tipo_pictograma.".imagen,
		imagenes_".$id_tipo_pictograma.".fecha_creacion,
		imagenes_".$id_tipo_pictograma.".ultima_modificacion,
...
//*********************************************************//
	...
	function listar_originales_es($registrado,$id_tipo,$letra,$filtrado,$orden,$id_subtema,$id_tipo_pictograma,$sql,$txt_locate) {
		...
		if ($letra=="") { $sql_letra=''; } 
			...
			switch ($txt_locate) { 
				...
				case 1:
				$sql_letra="AND palabras.palabra_es LIKE _utf8'$letra%%' COLLATE utf8_general_ci";
				break;
...
//*********************************************************//
	...
	function listar_originales_limit_es($registrado,$inicial,$cantidad,$id_tipo,$letra,$filtrado,$orden,$id_subtema,$id_tipo_pictograma,$sql,$txt_locate) {
		...
		imagenes_".$id_tipo_pictograma.".fecha_creacion,
		imagenes_".$id_tipo_pictograma.".ultima_modificacion,
		palabras.definicion,palabras.palabra_es,
		palabras.id_palabra,palabras.id_tipo_palabra  
		$subtema_tabla
		FROM palabra_imagen, imagenes_".$id_tipo_pictograma.", palabras $subtema_tabla_from
		WHERE imagenes_".$id_tipo_pictograma.".estado=1
...
//*********************************************************//
	...
	function listar_pictogramas_idioma($registrado,$id_tipo,$letra,$filtrado,$orden,$id_subtema,$id_idioma,$tipo_pictograma) {
		...
		if ($registrado==false) {
			$mostrar_registradas="AND imagenes_".$tipo_pictograma.".registrado=0";
		}
		...
		if ($letra=="") { $sql_letra=''; } 
		else { $sql_letra="AND traducciones_".$id_idioma.".traduccion LIKE '$letra%%'"; }
		
		if ($filtrado==1) { $sql_filtrado='imagenes_'.$tipo_pictograma.'.ultima_modificacion'; } 
		elseif ($filtrado==2) { $sql_filtrado='palabras.palabra'; }
		
		$query = "SELECT DISTINCT 
		palabra_imagen.id_palabra,
		palabra_imagen.id_imagen, 
		imagenes_".$tipo_pictograma.".id_imagen,
		imagenes_".$tipo_pictograma.".id_colaborador,
		imagenes_".$tipo_pictograma.".imagen,
		imagenes_".$tipo_pictograma.".extension,
		imagenes_".$tipo_pictograma.".id_tipo_imagen,
		imagenes_".$tipo_pictograma.".estado,
		imagenes_".$tipo_pictograma.".registrado,
		imagenes_".$tipo_pictograma.".id_licencia,
		imagenes_".$tipo_pictograma.".id_autor,
		imagenes_".$tipo_pictograma.".tags_imagen,
		imagenes_".$tipo_pictograma.".tipo_pictograma,
		imagenes_".$tipo_pictograma.".validos_senyalectica,
		imagenes_".$tipo_pictograma.".original_filename,
		palabras.*, traducciones_".$id_idioma.".* $subtema_tabla
		FROM palabra_imagen, imagenes_".$tipo_pictograma.", 
		palabras, traducciones_".$id_idioma." $subtema_tabla_from
		WHERE imagenes_".$tipo_pictograma.".estado=1
		...
		$sql_tipo
		$sql_subtema	
		AND palabra_imagen.id_imagen=imagenes_".$tipo_pictograma.".id_imagen
		$mostrar_registradas
		ORDER BY $sql_filtrado $orden";
...
//*********************************************************//
	...
	function listar_pictogramas_idioma_limit($registrado,$inicial,$cantidad,$id_tipo,$letra,$filtrado,$orden,$id_subtema,$id_idioma,$tipo_pictograma) {
		...
		imagenes_".$tipo_pictograma.".original_filename,
		palabras.*, 
		traducciones_".$id_idioma.".* $subtema_tabla
		FROM palabra_imagen, imagenes_".$tipo_pictograma.", 
		palabras, traducciones_".$id_idioma." $subtema_tabla_from
		WHERE imagenes_".$tipo_pictograma.".estado=1
		AND traducciones_".$id_idioma.".id_palabra=palabra_imagen.id_palabra
...
//*********************************************************//
	...
	function listar_originales_idioma($registrado,$id_tipo,$letra,$filtrado,$orden,$id_subtema,$id_idioma,$tipo_pictograma,$txt_locate,$sql) {
		...
		$query = "SELECT COUNT(*)
		FROM palabra_imagen, imagenes_".$tipo_pictograma.", palabras, 
		traducciones_".$id_idioma." $subtema_tabla_from
		WHERE imagenes_".$tipo_pictograma.".estado=1
		AND traducciones_".$id_idioma.".id_palabra=palabra_imagen.id_palabra
		AND traducciones_".$id_idioma.".id_palabra=palabras.id_palabra
		AND traducciones_".$id_idioma.".traduccion IS NOT NULL
...
//*********************************************************//
	...
	function listar_originales_idioma_limit($registrado,$inicial,$cantidad,$id_tipo,$letra,$filtrado,$orden,$id_subtema,$id_idioma,$tipo_pictograma,$txt_locate,$sql) {
		...
		imagenes_".$tipo_pictograma.".id_imagen,
		imagenes_".$tipo_pictograma.".imagen,
		imagenes_".$tipo_pictograma.".fecha_creacion,
		imagenes_".$tipo_pictograma.".ultima_modificacion,
		palabras.id_palabra,
		palabras.id_tipo_palabra,
		traducciones_".$id_idioma.".traduccion,
		traducciones_".$id_idioma.".explicacion,
		traducciones_".$id_idioma.".id_traduccion,
		traducciones_".$id_idioma.".id_idioma  
		$subtema_tabla
		FROM palabra_imagen, imagenes_".$tipo_pictograma.", 
		palabras, traducciones_".$id_idioma." $subtema_tabla_from
		WHERE imagenes_".$tipo_pictograma.".estado=1
...
//*********************************************************//
	...
	function listar_lse_color($registrado,$id_tipo,$letra,$filtrado,$orden,$id_subtema) {
		...
		if ($registrado==false) {
			$mostrar_registradas="AND imagenes_12.registrado=0";
		}
		...
		if ($filtrado==1) { $sql_filtrado='imagenes_12.ultima_modificacion'; } 
		elseif ($filtrado==2) { $sql_filtrado='palabras.palabra'; }
		
		$query = "SELECT DISTINCT 
		palabra_imagen.id_palabra,
		palabra_imagen.id_imagen, 
		imagenes_12.id_imagen,
		imagenes_12.id_colaborador,
		imagenes_12.imagen,
		imagenes_12.extension,
		imagenes_12.id_tipo_imagen,
		imagenes_12.estado,
		imagenes_12.registrado,
		imagenes_12.id_licencia,
		imagenes_12.id_autor,
		imagenes_12.tags_imagen,
		imagenes_12.tipo_pictograma,
		imagenes_12.validos_senyalectica,
		imagenes_12.original_filename,
		palabras.* $subtema_tabla
		FROM palabra_imagen, imagenes_12, palabras $subtema_tabla_from
		WHERE imagenes_12.estado=1
		AND palabras.id_palabra=palabra_imagen.id_palabra
		$sql_letra
		$sql_tipo
		$sql_subtema	
...
//   LISTAR ULTIMOS SIGNOS LSE COLOR A�ADIDOS LIMIT          //
//*********************************************************//
	...
	function listar_lse_color_limit($registrado,$inicial,$cantidad,$id_tipo,$letra,$filtrado,$orden,$id_subtema) {
		...
		imagenes_12.original_filename,
		palabras.* $subtema_tabla
		FROM palabra_imagen, imagenes_12, 
		palabras $subtema_tabla_from
		WHERE imagenes_12.estado=1
		AND palabras.id_palabra=palabra_imagen.id_palabra
		$sql_letra
...
//   LISTAR ULTIMOS SIGNOS LSE B&N A�ADIDOS        //
//*********************************************************//

	function listar_lse_byn($registrado,$id_tipo,$letra,$filtrado,$orden,$id_subtema) {
	
		if ($registrado==false) {
			$mostrar_registradas="AND imagenes_13.registrado=0";
		}
		...
		if ($filtrado==1) { $sql_filtrado='imagenes_13.ultima_modificacion'; } 
		elseif ($filtrado==2) { $sql_filtrado='palabras.palabra'; }
		
		$query = "SELECT DISTINCT 
		palabra_imagen.id_palabra,
		palabra_imagen.id_imagen, 
		imagenes_13.id_imagen,
		imagenes_13.id_colaborador,
		imagenes_13.imagen,
		imagenes_13.extension,
		imagenes_13.id_tipo_imagen,
		imagenes_13.estado,
		imagenes_13.registrado,
		imagenes_13.id_licencia,
		imagenes_13.id_autor,
		imagenes_13.tags_imagen,
		imagenes_13.tipo_pictograma,
		imagenes_13.validos_senyalectica,
		imagenes_13.original_filename,
		palabras.* $subtema_tabla
		FROM palabra_imagen, imagenes_13, palabras $subtema_tabla_from
		WHERE imagenes_13.estado=1
		AND palabras.id_palabra=palabra_imagen.id_palabra
		$sql_letra
		$sql_tipo
		$sql_subtema	
		AND palabra_imagen.id_imagen=imagenes_13.id_imagen
		$mostrar_registradas
		ORDER BY $sql_filtrado $orden";
...
//   LISTAR ULTIMOS SIGNOS LSE B&N A�ADIDOS LIMIT          //
//*********************************************************//
...
//*********************************************************//
	...
	function listar_videos_acepciones_lse($registrado,$id_tipo,$letra,$filtrado,$orden,$id_subtema) {
		...
		if ($registrado==false) {
			$mostrar_registradas="AND imagenes_11.registrado=0";
		}
		...
		if ($filtrado==1) { $sql_filtrado='imagenes_11.ultima_modificacion'; } 
		elseif ($filtrado==2) { $sql_filtrado='palabras.palabra'; }
		
		$query = "SELECT DISTINCT 
		palabra_imagen.id_palabra,
		palabra_imagen.id_imagen, 
		imagenes_11.id_imagen,
		imagenes_11.id_colaborador,
		imagenes_11.imagen,
		imagenes_11.extension,
		imagenes_11.id_tipo_imagen,
		imagenes_11.estado,
		imagenes_11.registrado,
		imagenes_11.id_licencia,
		imagenes_11.id_autor,
		imagenes_11.tags_imagen,
		imagenes_11.tipo_pictograma,
		imagenes_11.validos_senyalectica,
		imagenes_11.original_filename,
		palabras.* $subtema_tabla
		FROM palabra_imagen, imagenes_11, palabras $subtema_tabla_from
		WHERE imagenes_11.estado=1
		AND palabras.id_palabra=palabra_imagen.id_palabra
		$sql_letra
		$sql_tipo
		$sql_subtema	
...
//*********************************************************//
	...
	function listar_originales_limit_para_generador($inicial,$cantidad,$id_tipo_simbolo) {
		...
		if ($id_tipo_simbolo==99) { 
			$query = "SELECT 
				palabra_imagen.id_palabra,
				palabra_imagen.id_imagen, 
				imagenes.id_imagen,
				imagenes.id_colaborador,
				imagenes.imagen,
				imagenes.extension,
				imagenes.id_tipo_imagen,
				imagenes.estado,
				imagenes.registrado,
				imagenes.id_licencia,
				imagenes.id_autor,
				imagenes.tags_imagen,
				imagenes.tipo_pictograma,
				imagenes.validos_senyalectica,
				imagenes.original_filename,
				palabras.*
			...
			$query = "SELECT 
				palabra_imagen.id_palabra,
				palabra_imagen.id_imagen, 
				imagenes_".$id_tipo_simbolo.".id_imagen,
				imagenes_".$id_tipo_simbolo.".id_colaborador,
				imagenes_".$id_tipo_simbolo.".imagen,
				imagenes_".$id_tipo_simbolo.".extension,
				imagenes_".$id_tipo_simbolo.".id_tipo_imagen,
				imagenes_".$id_tipo_simbolo.".estado,
				imagenes_".$id_tipo_simbolo.".registrado,
				imagenes_".$id_tipo_simbolo.".id_licencia,
				imagenes_".$id_tipo_simbolo.".id_autor,
				imagenes_".$id_tipo_simbolo.".tags_imagen,
				imagenes_".$id_tipo_simbolo.".tipo_pictograma,
				imagenes_".$id_tipo_simbolo.".validos_senyalectica,
				imagenes_".$id_tipo_simbolo.".original_filename,
				palabras.*
				FROM palabra_imagen, imagenes_".$id_tipo_simbolo.", palabras
				WHERE imagenes_".$id_tipo_simbolo.".estado=1
				AND palabras.id_palabra=palabra_imagen.id_palabra
				AND palabra_imagen.id_imagen=imagenes_".$id_tipo_simbolo.".id_imagen
				ORDER BY palabra_imagen.id_imagen asc
				LIMIT $inicial,$cantidad";
		}
...
//*********************************************************//
	...
	function ultimas_imagenes($limit,$registrado) {
		...
		imagenes_2.validos_senyalectica,
		imagenes_2.original_filename,
		imagenes_2.ultima_modificacion,
		palabra_imagen.id_palabra,
		palabra_imagen.id_imagen, 
		palabras.*, 
		tipos_imagen.*
		FROM imagenes_2, palabra_imagen, palabras, tipos_imagen
		WHERE imagenes_2.estado=1 
		AND imagenes_2.id_imagen=palabra_imagen.id_imagen
		AND palabra_imagen.id_palabra=palabras.id_palabra 
		AND imagenes_2.id_tipo_imagen=tipos_imagen.id_tipo
		$mostrar_registradas
		ORDER BY imagenes_2.ultima_modificacion desc 
		LIMIT 0,$limit";
...
//*********************************************************//
	...
	function ultimos_cliparts($limit,$registrado) {
		...
		imagenes_9.validos_senyalectica,
		imagenes_9.original_filename,
		imagenes_9.ultima_modificacion,
		palabra_imagen.id_palabra,
		palabra_imagen.id_imagen, 
		palabras.*, 
		tipos_imagen.*
		FROM imagenes_9, palabra_imagen, palabras, tipos_imagen
		WHERE imagenes_9.estado=1 
		AND imagenes_9.id_imagen=palabra_imagen.id_imagen
		AND palabra_imagen.id_palabra=palabras.id_palabra 
		AND imagenes_9.id_tipo_imagen=tipos_imagen.id_tipo
		$mostrar_registradas
		ORDER BY imagenes_9.ultima_modificacion desc 
		LIMIT 0,$limit";
...
//*********************************************************//
	...
	function ultimos_pictogramas_color($limit,$registrado) {
		...
		imagenes_10.validos_senyalectica,
		imagenes_10.original_filename,
		imagenes_10.ultima_modificacion,
		palabra_imagen.id_palabra,
		palabra_imagen.id_imagen, 
		palabras.*, 
		tipos_imagen.*
		FROM imagenes_10, palabra_imagen, palabras, tipos_imagen
		WHERE imagenes_10.estado=1 
		AND imagenes_10.id_imagen=palabra_imagen.id_imagen
		AND palabra_imagen.id_palabra=palabras.id_palabra 
		AND imagenes_10.id_tipo_imagen=tipos_imagen.id_tipo
		$mostrar_registradas
		ORDER BY imagenes_10.ultima_modificacion desc 
		LIMIT 0,$limit";
...
//*********************************************************//
	...
	function ultimos_pictogramas_byn($limit,$registrado) {
		...
		imagenes_5.validos_senyalectica,
		imagenes_5.original_filename,
		imagenes_5.ultima_modificacion,
		palabra_imagen.id_palabra,
		palabra_imagen.id_imagen, 
		palabras.*, 
		tipos_imagen.*
		FROM imagenes_5, palabra_imagen, palabras, tipos_imagen
		WHERE imagenes_5.estado=1 
		AND imagenes_5.id_imagen=palabra_imagen.id_imagen
		AND palabra_imagen.id_palabra=palabras.id_palabra 
		AND imagenes_5.id_tipo_imagen=tipos_imagen.id_tipo
		$mostrar_registradas
		ORDER BY imagenes_5.ultima_modificacion desc 
		LIMIT 0,$limit";
...
//*********************************************************//
	...
	function ultimos_pictogramas_limit($limit,$id_tipo_imagen,$registrado) {
		...
		if ($registrado==false) {
			$mostrar_registradas="AND imagenes_".$id_tipo_imagen.".registrado=0";
		}
			
		$query = "SELECT 
		imagenes_".$id_tipo_imagen.".id_imagen,
		imagenes_".$id_tipo_imagen.".id_colaborador,
		imagenes_".$id_tipo_imagen.".imagen,
		imagenes_".$id_tipo_imagen.".extension,
		imagenes_".$id_tipo_imagen.".id_tipo_imagen,
		imagenes_".$id_tipo_imagen.".estado,
		imagenes_".$id_tipo_imagen.".registrado,
		imagenes_".$id_tipo_imagen.".id_licencia,
		imagenes_".$id_tipo_imagen.".id_autor,
		imagenes_".$id_tipo_imagen.".tags_imagen,
		imagenes_".$id_tipo_imagen.".tipo_pictograma,
		imagenes_".$id_tipo_imagen.".validos_senyalectica,
		imagenes_".$id_tipo_imagen.".original_filename,
		imagenes_".$id_tipo_imagen.".ultima_modificacion,
		palabra_imagen.id_palabra,
		palabra_imagen.id_imagen, 
		palabras.*, 
		tipos_imagen.*
		FROM imagenes_".$id_tipo_imagen.", palabra_imagen, 
		palabras, tipos_imagen
		WHERE imagenes_".$id_tipo_imagen.".estado=1 
		AND imagenes_".$id_tipo_imagen.".id_imagen=palabra_imagen.id_imagen
		AND palabra_imagen.id_palabra=palabras.id_palabra 
		AND imagenes_".$id_tipo_imagen.".id_tipo_imagen=tipos_imagen.id_tipo
		$mostrar_registradas
		ORDER BY imagenes_".$id_tipo_imagen.".ultima_modificacion desc 
		LIMIT 0,$limit";
...
//******************************************************************************//	
	...
	function listar_simbolos($id_tipo_palabra,$letra,$id_tipo_simbolo,$idioma,$registrado) {
		...
		$sql_idioma
		$mostrar_registradas
		AND palabras.palabra LIKE _utf8'$sql_letra%%' COLLATE utf8_general_ci 
...
//******************************************************************************//
	function palabras_asociadas($id_imagen,$id_palabra) {
		...
		$query = "SELECT palabras.*, palabra_imagen.id_palabra,palabra_imagen.id_imagen
...
//******************************************************************************//	
	...
	function listar_diccionario_palabras($id_tipo,$letra) {
		...
		$query = "SELECT palabras.*
		FROM palabras
		WHERE palabras.palabra LIKE _utf8'$sql_letra%%' COLLATE utf8_general_ci $sql_tipo  
		ORDER BY palabras.palabra asc";
...
//******************************************************************************//	
	...
	function listar_diccionario_palabras_con_imagenes($id_tipo,$letra) {
		...
		palabra_imagen.id_imagen 
		FROM palabras, palabra_imagen
		WHERE palabras.palabra LIKE _utf8'$sql_letra%%' COLLATE utf8_general_ci 
		$sql_tipo 
		AND  palabras.id_palabra = palabra_imagen.id_palabra
		GROUP BY palabras.id_palabra
		ORDER BY palabras.palabra asc";
...
//******************************************************************************//	
	...
	function listar_diccionario_idiomas_palabras_con_imagenes($id_tipo,$letra,$id_idioma) {
		...
		$query = "SELECT DISTINCT 
		traducciones_".$id_idioma.".*, 
		palabra_imagen.id_palabra,
		palabra_imagen.id_imagen, 
		palabras.*
		FROM traducciones_".$id_idioma.", palabra_imagen, palabras
		WHERE traducciones_".$id_idioma.".traduccion LIKE '$sql_letra%%' 
		AND traducciones_".$id_idioma.".id_palabra = palabra_imagen.id_palabra
		AND traducciones_".$id_idioma.".id_palabra = palabras.id_palabra
		$sql_tipo 
		GROUP BY traducciones_".$id_idioma.".id_palabra
		ORDER BY traducciones_".$id_idioma.".traduccion asc";
...
//******************************************************************************//	
	...
	function listar_diccionario_idiomas_palabras_con_imagenes_limit($id_tipo,$letra,$inicial,$cantidad,$id_idioma) {
		...
		traducciones_".$id_idioma.".*, 
		palabra_imagen.id_palabra,
		palabra_imagen.id_imagen, palabras.*
		FROM traducciones_".$id_idioma.", palabra_imagen, palabras
		WHERE traducciones_".$id_idioma.".traduccion LIKE '$sql_letra%%' 
		AND traducciones_".$id_idioma.".id_palabra = palabra_imagen.id_palabra
		AND traducciones_".$id_idioma.".id_palabra=palabras.id_palabra
...
//******************************************************************************//	
	...
	function listar_diccionario_idiomas_palabras($id_tipo,$letra,$id_idioma) {
		...
		$query = "SELECT DISTINCT traducciones_".$id_idioma.".*, palabras.*
...
//******************************************************************************//	
	...
	function listar_diccionario_idiomas_palabras_por_tipos_con_imagenes_limit($sql,$letra,$inicial,$cantidad,$id_idioma) {
		...
		imagenes.validos_senyalectica,
		imagenes.original_filename
		FROM traducciones_".$id_idioma.", palabra_imagen, imagenes
		WHERE traducciones_".$id_idioma.".traduccion LIKE '$sql_letra%' 
		AND traducciones_".$id_idioma.".id_palabra = palabra_imagen.id_palabra
		AND palabra_imagen.id_imagen=imagenes.id_imagen
		$sql
		GROUP BY traducciones_".$id_idioma.".id_palabra
		ORDER BY traducciones_".$id_idioma.".traduccion
		LIMIT $inicial,$cantidad";
...
//******************************************************************************//	
	...
	function simbolos_por_palabra_con_filtro($palabra,$id_tipo_palabra,$id_tipo_simbolo,$registrado,$marco,$contraste,$tipo_letra,$mayusculas,$minusculas,$castellano,$ruso,$rumano,$arabe,$chino,$bulgaro,$polaco,$ingles,$frances,$catalan) {
		...
		FROM simbolos, palabras, tipos_simbolos
		WHERE simbolos.id_palabra=palabras.id_palabra
		AND palabras.palabra LIKE _utf8'%$palabra%' COLLATE utf8_general_ci
		$sql_tipo_simbolo
		$sql_tipo_palabra
		$sql_marco
		$sql_contraste
...
//******************************************************************************//	
	...
	function imagenes_por_palabra($id_palabra,$registrado,$estado) {
		...
		imagenes.id_imagen,
		imagenes.id_colaborador,
		imagenes.imagen,imagenes.extension,
		imagenes.id_tipo_imagen,
		imagenes.estado,
		imagenes.registrado,
		imagenes.id_licencia,
...
//******************************************************************************//	
	...
	function imagenes_por_palabra_y_tipo_imagen($id_palabra,$registrado,$estado,$id_tipo_imagen) {
		...
		if ($id_tipo_imagen==99) { 
			...
			if ($estado !='' && $estado < 4 && $estado > 0) {
				$sql_estado='AND imagenes_'.$id_tipo_imagen.'.estado='.$estado.'';
			} elseif ($estado='all') {
				$sql_estado='';
			} else {
				$sql_estado='AND imagenes_'.$id_tipo_imagen.'.estado=1';
			}
			...
			imagenes_".$id_tipo_imagen.".validos_senyalectica,
			imagenes_".$id_tipo_imagen.".original_filename
			FROM palabra_imagen, imagenes_".$id_tipo_imagen."
			WHERE palabra_imagen.id_palabra='$id_palabra'
			AND palabra_imagen.id_imagen=imagenes_".$id_tipo_imagen.".id_imagen
			$mostrar_registradas
			$sql_estado"; 
...
//******************************************************************************//	
	...
	function listar_palabras_con_imagenes($id_tipo,$letra,$registrado) {
		...
		palabras.*
		FROM palabra_imagen, imagenes, palabras
		WHERE palabras.palabra LIKE _utf8'$letra%%' COLLATE utf8_general_ci
		$sql_tipo
		AND palabras.id_palabra=palabra_imagen.id_palabra
		AND palabra_imagen.id_imagen=imagenes.id_imagen
		$mostrar_registradas
...
//                   FUNCION LISTAR TRADUCCIONES	- NO SE USA DEJAR COMO EST�  //
//******************************************************************************//	
...
//******************************************************************************//	
	...
	function datos_imagen($id_imagen) {
		...
		imagenes.validos_senyalectica,
		imagenes.original_filename,
		imagenes.fecha_creacion,
		imagenes.ultima_modificacion,
		palabra_imagen.id_palabra,
		palabra_imagen.id_imagen, 
		palabras.*, 
		tipos_imagen.*,
		...
		tipos_imagen, colaboradores, licencias, autores
...
//                   FUNCION DATOS IMAGEN  TIPO DE IMAGEN      //
//******************************************************************************//	

	function datos_imagen_tipo_imagen($id_imagen) {
		$query = "SELECT 
		imagenes.id_imagen,
		imagenes.id_tipo_imagen
		FROM imagenes
...
//                IDIOMAS DISPONIBLES PARA LA PALABRA  - REVISADO Y OPTMIZADO    //
//******************************************************************************//	
...
//******************************************************************************//	
	...
	function imagenes_disponibles_tipo($id_palabra,$id_tipo) {
		$query = "SELECT palabras.*, tipos_palabra.*, 
		imagenes_".$id_tipo.".id_imagen,
		imagenes_".$id_tipo.".id_colaborador,
		imagenes_".$id_tipo.".imagen,
		imagenes_".$id_tipo.".extension,
		imagenes_".$id_tipo.".id_tipo_imagen,
		imagenes_".$id_tipo.".estado,
		imagenes_".$id_tipo.".registrado,
		imagenes_".$id_tipo.".id_licencia,
		imagenes_".$id_tipo.".id_autor,
		imagenes_".$id_tipo.".tags_imagen,
		imagenes_".$id_tipo.".tipo_pictograma,
		imagenes_".$id_tipo.".validos_senyalectica,
		imagenes_".$id_tipo.".original_filename,
		palabra_imagen.id_palabra,palabra_imagen.id_imagen
		FROM palabras, tipos_palabra, imagenes_".$id_tipo.", palabra_imagen
		WHERE palabras.id_palabra = '$id_palabra'
		AND palabra_imagen.id_palabra = '$id_palabra'
		AND palabra_imagen.id_imagen = imagenes_".$id_tipo.".id_imagen
		AND tipos_palabra.id_tipo_palabra=palabras.id_tipo_palabra";
...
//******************************************************************************//	
	...
	function imagenes_disponibles_idioma_tipo($id_traduccion,$id_tipo,$id_idioma) {
		...
		imagenes_".$id_tipo.".original_filename,
		palabra_imagen.id_palabra,palabra_imagen.id_imagen
		FROM traducciones_".$id_idioma.", imagenes_".$id_tipo.", palabra_imagen
...
//******************************************************************************//	
	...
	function imagenes_disponibles_solo_por_tipo($id_tipo,$limite) {
		...
		imagenes_".$id_tipo.".validos_senyalectica,
		imagenes_".$id_tipo.".original_filename,
		palabra_imagen.id_palabra,palabra_imagen.id_imagen,autores.*,licencias.*
		FROM palabras, imagenes_".$id_tipo.", palabra_imagen,autores,licencias
		WHERE imagenes_".$id_tipo.".id_imagen=palabra_imagen.id_imagen
		AND palabra_imagen.id_palabra = palabras.id_palabra
		AND imagenes_".$id_tipo.".id_autor=autores.id_autor
		AND imagenes_".$id_tipo.".id_licencia=licencias.id_licencia
		ORDER BY imagenes_".$id_tipo.".id_imagen desc
		LIMIT 0,$limite";
...
//******************************************************************************//	
	...
	function imagenes_disponibles_tipo_por_palabra($palabra,$id_tipo) {
		...
		palabra_imagen.id_palabra,palabra_imagen.id_imagen
		FROM palabras, tipos_palabra, imagenes_".$id_tipo.", palabra_imagen
		WHERE palabras.palabra LIKE _utf8'%$palabra%' COLLATE utf8_general_ci
		AND palabra_imagen.id_palabra = palabras.id_palabra
		AND palabra_imagen.id_imagen = imagenes_".$id_tipo.".id_imagen
		AND tipos_palabra.id_tipo_palabra=palabras.id_tipo_palabra";
...
//******************************************************************************//	
	...
	function imagenes_disponibles_tipo_por_tag($tag,$id_tipo) {
		...
		imagenes_".$id_tipo.".validos_senyalectica,
		imagenes_".$id_tipo.".original_filename,
		palabra_imagen.id_palabra,palabra_imagen.id_imagen, palabras.*
		FROM imagenes_".$id_tipo.", palabra_imagen, palabras
		WHERE imagenes_".$id_tipo.".tags_imagen LIKE '%{".$tag."}%'
		AND palabra_imagen.id_palabra = palabras.id_palabra
		AND palabra_imagen.id_imagen = imagenes_".$id_tipo.".id_imagen";
...
//******************************************************************************//	
	...
	function imagenes_disponibles_idioma_tipo_por_tag($tag,$id_tipo,$id_idioma) {
		...
		imagenes_".$id_tipo.".validos_senyalectica,
		imagenes_".$id_tipo.".original_filename,
		palabra_imagen.id_palabra,palabra_imagen.id_imagen, traducciones_".$id_idioma.".*
		FROM imagenes_".$id_tipo.", palabra_imagen, traducciones_".$id_idioma."
		WHERE imagenes_".$id_tipo.".tags_imagen LIKE '%{".$tag."}%'
		AND traducciones_".$id_idioma.".id_idioma=$id_idioma
		AND palabra_imagen.id_palabra = traducciones_".$id_idioma.".id_palabra
		AND palabra_imagen.id_imagen = imagenes_".$id_tipo.".id_imagen";
...
//                NUBE DE TAGS   -   REVISADA                                               //
//******************************************************************************//	
// ESTA CONSULTA NO SE PUEDE HACER A PARTIR DE LAS TABLAS DE IMAGENES SEPARADAS
// YA QUE CONSTRUYE LA NUBE DE TAGS A PARTIR DE LOS TAGS DE TODAS LAS IMAGENES
//******************************************************************************//	
	...
	function construir_nube_tags($n) {
		...
		// Compongo el c�digo para ser almacenado en el archivo
		 $nube_tags='<?php ';
...
//******************************************************************************//	
	...
	function buscar_palabras($txt) {
		$query = "SELECT palabras.*
		FROM palabras
		WHERE palabras.palabra LIKE _utf8'$txt%%' COLLATE utf8_general_ci";
...
//******************************************************************************//	
	...
	function buscar_acepcion_lse($id_palabra) {
		...
		imagenes_11.validos_senyalectica,
		imagenes_11.original_filename
		FROM palabra_imagen, imagenes_11
		WHERE palabra_imagen.id_imagen=imagenes_11.id_imagen
		AND palabra_imagen.id_palabra='$id_palabra'";
...
// 					FUNCION ACTUALIZAR PALABRA ISO-8859-1 		                     //
//******************************************************************************//
	function actualizar_palabra_es($id_palabra,$palabra_es) {

		$UpdateRecords = "UPDATE palabras SET palabra_es='$palabra_es'
		WHERE id_palabra='$id_palabra'";
        $connection = mysql_connect($this->HOST, $this->USERNAME, $this->PASSWORD);
		$SelectedDB = mysql_select_db($this->DBNAME);
		$result = mysql_query($UpdateRecords);
...
// 					FUNCION ACTUALIZAR SI HAY O NO LOCUCION - NO SE USA ESTA FUNCION  //
//******************************************************************************//
...
// 		FUNCION ACTUALIZAR SI HAY O NO LOCUCION PARA TRADUCCION - NO SE USA ESTA FUNCION //
//******************************************************************************//
...
//******************************************************************************//	
	...
	function buscar_traduccion($id_palabra,$id_idioma) {
		$query = "SELECT palabras.*, traducciones_".$id_idioma.".*, idiomas.*
		FROM palabras, traducciones_".$id_idioma.", idiomas
		WHERE traducciones_".$id_idioma.".id_palabra = $id_palabra
		AND traducciones_".$id_idioma.".id_idioma = idiomas.id_idioma
		AND traducciones_".$id_idioma.".id_palabra = palabras.id_palabra";
	...
	function buscar_traduccion_por_idioma($id_idioma) {
		$query = "SELECT palabras.*, traducciones_".$id_idioma.".*, idiomas.*
		FROM palabras, traducciones_".$id_idioma.", idiomas
		WHERE traducciones_".$id_idioma.".id_idioma = idiomas.id_idioma
		AND traducciones_".$id_idioma.".id_palabra = palabras.id_palabra
		ORDER BY traducciones_".$id_idioma.".id_palabra ASC";
	...
	function buscar_traduccion_por_idioma_sin_asociar_palabra($id_idioma) {
		$query = "SELECT traducciones_".$id_idioma.".*, idiomas.*
		FROM traducciones_".$id_idioma.", idiomas
		WHERE traducciones_".$id_idioma.".id_idioma = idiomas.id_idioma
		ORDER BY traducciones_".$id_idioma.".id_palabra ASC";
	...
	//REVISADA PERO MEJOR DEJARLA AS� PORQUE CUANDO SE HACE NO SE SABE EL IDIOMA
	...
	//ESTA FUNCION SE USA EN GENERAR LISTADOS SOLO EN LOCAL NO HAY QUE TOCARLA
...
function do_upload($upload_dir,$upload_url,$query,$id_dir,$ruta,$id_user) {
  ...
  if (!chmod($file_path,0777))
    ...
    $message = "$file_name ha sido a�adido correctamente.";
  return $message;
}
...
// 		INSERTAR TRADUCCION  - REVISADO y A�ADIDO EL INSERT A LA TABLA ESPECIFICA DEL IDIOMA                     //
//******************************************************************************//
	function add_traduccion($id_palabra, $id_idioma, $traduccion,$explicacion,$pronunciacion,$id_colaborador,$estado) {
		...
		$ssql = "INSERT INTO traducciones (id_palabra, traduccion, explicacion,pronunciacion, id_idioma, id_colaborador,  estado, fecha_alta, fecha_modificacion) 
			...
			if (mysql_query($ssql,$connection)){
				...
				$ssql22 = "INSERT INTO traducciones_".$id_idioma." (id_traduccion,id_palabra, traduccion, explicacion,pronunciacion, id_idioma, id_colaborador, estado,fecha_alta,fecha_modificacion,definicion_traduccion,estado_definicion_traduccion) 
					VALUES ('$ultimo_id','$id_palabra','$traduccion','$explicacion','$pronunciacion','$id_idioma', '$id_colaborador','$estado','$fecha','$fecha','',0)";
				$result = mysql_query($ssql22,$connection); 
				mysql_close($connection);
				return $ultimo_id;
...
//******************************************************************************//
	function add_palabra($PickList,$palabra, $definicion, $id_tipo_palabra,$id_colaborador,$estado) {
		$timestamp=time();
		$fecha=date("Y-m-d H:i:s",$timestamp);
		$palabra_es=utf8_decode($palabra);
		$connection = mysql_connect($this->HOST, $this->USERNAME, $this->PASSWORD);
		$SelectedDB = mysql_select_db($this->DBNAME);
		$ssql = "INSERT INTO palabras (palabra, palabra_utf8, definicion, id_tipo_palabra, id_colaborador, fecha_creacion, ultima_modificacion, estado) 
			VALUES ('$palabra_es', '$palabra', '$definicion', '$id_tipo_palabra', '$id_colaborador','$fecha', '$fecha','$estado')";
...
// 							A�ADIR NUEVO SIMBOLO A SELECCION                      //
//******************************************************************************//
...
// 							A�ADIR NUEVO FICHA EJEMPLOS DE USO                    //
//******************************************************************************//
...
//******************************************************************************//
	...
	$UpdateRecords = "UPDATE materiales 
		SET material_titulo='$titulo', material_descripcion='$descripcion', 
		material_objetivos='$objetivos',
...
// 					FUNCION ACTUALIZAR NUMERO DE VECES VISTO S�MBOLO              //
//******************************************************************************//
...
//******************************************************************************//
	function actualizar_imagen($id_imagen,$id_tipo_imagen,$estado,$registrado,$id_licencia,$id_autor,$tags,$tipo_pictograma,$validos_senyalectica) {
		...
		$UpdateRecords1 = "UPDATE imagenes_".$id_tipo_imagen." 
		SET estado='$estado', 
		registrado='$registrado', ultima_modificacion='$fecha',
		id_licencia='$id_licencia', id_autor='$id_autor',
		tags_imagen='$tags', id_tipo_imagen='$id_tipo_imagen',
		...
		validos_senyalectica='$validos_senyalectica'
		WHERE id_imagen='$id_imagen'";
        $connection1 = mysql_connect($this->HOST, $this->USERNAME, $this->PASSWORD);
		$SelectedDB1 = mysql_select_db($this->DBNAME);
		$result1 = mysql_query($UpdateRecords1); 
		mysql_close($connection1);
			
	}

// 	 	FUNCION ACTUALIZAR IMAGEN CAMBIANDO EL TIPO DE IMAGEN		             //
//******************************************************************************//
	function actualizar_imagen_cambiando_tipo_imagen($id_imagen,$id_tipo_imagen,$estado,$registrado,$id_licencia,$id_autor,$tags,$tipo_pictograma,$validos_senyalectica,$id_tipo_imagen_old,$id_usuario,$fecha_creacion,$original_filename,$imagen,$extension) {
		...
		$connection2 = mysql_connect($this->HOST, $this->USERNAME, $this->PASSWORD);
		$SelectedDB2 = mysql_select_db($this->DBNAME);
		$qDelete2 = "DELETE FROM imagenes_".$id_tipo_imagen_old." WHERE id_imagen='$id_imagen'";	
		$result2 = mysql_query($qDelete2);
		mysql_close($connection2);
		
		$connection3 = mysql_connect($this->HOST, $this->USERNAME, $this->PASSWORD);
		$SelectedDB3 = mysql_select_db($this->DBNAME);
		$ssql3 = "INSERT INTO imagenes_".$id_tipo_imagen." (id_imagen,id_colaborador,id_tipo_imagen,
		fecha_creacion, ultima_modificacion, estado, registrado,id_autor,id_licencia,tags_imagen,
		tipo_pictograma,validos_senyalectica,original_filename,imagen,extension) 
			VALUES ('$id_imagen','$id_usuario','$id_tipo_imagen','$fecha_creacion','$fecha', '$estado','$registrado','$id_autor','$id_licencia','$tags','$tipo_pictograma','$validos_senyalectica','$original_filename','$imagen','$extension')";
		$result = mysql_query($ssql3,$connection3);
			...
			if (mysql_query($ssql,$connection)){
				...
				foreach ($palabras_seleccionadas as $key => $value) {
					...
					if ($value != '') {
						...
						$ssql3= "INSERT INTO imagenes_".$id_tipo_imagen."(id_imagen,id_colaborador,id_tipo_imagen,fecha_creacion, ultima_modificacion, estado, registrado,id_autor,id_licencia,tags_imagen,tipo_pictograma,validos_senyalectica,original_filename,imagen,extension) 
			VALUES ('$ultimo_id','$id_usuario', '$id_tipo_imagen', '$fecha', '$fecha', '$estado','$registrado','$id_autor','$id_licencia','$tags','$tipo_pictograma','$validos_senyalectica','$original_filename','$ultimo_id.$extension','$extension')";
						$result = mysql_query($ssql3,$connection);
...
// 	FUNCION ACTUALIZAR DEFINICION - REVISADO Y A�ADIDA LA MODIFICACION DE LA TRADUCCION EN LA TABLA ESPOECIFICA DEL IDIOMA//
//************************************************************************************************************************//
	function modify_traduccion($id_traduccion,$id_palabra,$id_idioma,$traduccion,$pronunciacion,$estado,$explicacion) {
		...
		$UpdateRecords1 = "UPDATE traducciones_".$id_idioma." SET traduccion='$traduccion', estado='$estado', pronunciacion='$pronunciacion',explicacion='$explicacion'
		WHERE id_palabra='$id_palabra' AND id_traduccion='$id_traduccion'";
        $connection = mysql_connect($this->HOST, $this->USERNAME, $this->PASSWORD);
		$SelectedDB = mysql_select_db($this->DBNAME);
		$result1 = mysql_query($UpdateRecords1);
...
// BORRAR TRADUCCION - REVISADO Y A�ADIDO EL BORRADO DE LA TRADUCCION EN LA TABLA ESPECIFICA POR IDIOMA
//********************************************************************************************************//	
	function borrar_traduccion($id_traduccion,$id_palabra,$id_idioma,$id_colaborador) {
		...
		$qDelete1 = "DELETE FROM traducciones_".$id_idioma." WHERE id_palabra='$id_palabra' AND id_traduccion='$id_traduccion'";	
...
//********************************************************************************************************//	
	function delete_imagen($id_imagen) {
		...
		$qDelete2 = "DELETE FROM imagenes_".$imagen['id_tipo_imagen']." WHERE id_imagen='$id_imagen'";	
		$result2 = mysql_query($qDelete2);
