...
//******************************************************************************//
	function actualizar_item_internacionalizacion($key,$contenido,$idioma) {
		...
		$UpdateRecords = "UPDATE internacionalizacion SET $idioma='$contenido' WHERE id_key='$key'";
        $connection = mysql_connect($this->HOST, $this->USERNAME, $this->PASSWORD);
		$SelectedDB = mysql_select_db($this->DBNAME);
	...
	function actualizar_item_tabla_idiomas($key,$contenido,$idioma) {
		...
		if ($idioma=='es') {
			$UpdateRecords = "UPDATE idiomas SET idioma_es='$contenido', idioma='$contenido' WHERE id_idioma='$key'";
			$connection = mysql_connect($this->HOST, $this->USERNAME, $this->PASSWORD);
			$SelectedDB = mysql_select_db($this->DBNAME);
			$result = mysql_query($UpdateRecords); 
			mysql_close($connection);
		} else {
			$UpdateRecords = "UPDATE idiomas SET idioma_$idioma='$contenido' WHERE id_idioma='$key'";
			$connection = mysql_connect($this->HOST, $this->USERNAME, $this->PASSWORD);
			$SelectedDB = mysql_select_db($this->DBNAME);
			$result = mysql_query($UpdateRecords); 
			mysql_close($connection);
	...
	function actualizar_item_tabla_categorias_enlaces($key,$contenido,$idioma) {
		...
		if ($idioma=='es') {
			$UpdateRecords = "UPDATE categorias_enlaces SET categoria='$contenido' WHERE id_categoria_enlace='$key'";
			$connection = mysql_connect($this->HOST, $this->USERNAME, $this->PASSWORD);
			$SelectedDB = mysql_select_db($this->DBNAME);
			$result = mysql_query($UpdateRecords); 
			mysql_close($connection);
		} else {
			$UpdateRecords = "UPDATE categorias_enlaces SET categoria_$idioma='$contenido' WHERE id_categoria_enlace='$key'";
			$connection = mysql_connect($this->HOST, $this->USERNAME, $this->PASSWORD);
			$SelectedDB = mysql_select_db($this->DBNAME);
			$result = mysql_query($UpdateRecords); 
			mysql_close($connection);
	...
	function actualizar_item_tabla_enlaces($key,$contenido,$idioma) {
		...
		if ($idioma=='es') {
			$UpdateRecords = "UPDATE enlaces SET enlace='$contenido' WHERE id_enlace='$key'";
			$connection = mysql_connect($this->HOST, $this->USERNAME, $this->PASSWORD);
			$SelectedDB = mysql_select_db($this->DBNAME);
			$result = mysql_query($UpdateRecords); 
			mysql_close($connection);
		} else {
			$UpdateRecords = "UPDATE enlaces SET enlace_$idioma='$contenido' WHERE id_enlace='$key'";
			$connection = mysql_connect($this->HOST, $this->USERNAME, $this->PASSWORD);
			$SelectedDB = mysql_select_db($this->DBNAME);
			$result = mysql_query($UpdateRecords);
			mysql_close($connection);
	...
	function actualizar_descripcion_item_tabla_enlaces($key,$contenido,$idioma) {
		...
		if ($idioma=='es') {
			$UpdateRecords = "UPDATE enlaces SET descripcion_enlace='$contenido' WHERE id_enlace='$key'";
			$connection = mysql_connect($this->HOST, $this->USERNAME, $this->PASSWORD);
			$SelectedDB = mysql_select_db($this->DBNAME);
			$result = mysql_query($UpdateRecords); 
			mysql_close($connection);
		} else {
			$UpdateRecords = "UPDATE enlaces SET descripcion_enlace_$idioma='$contenido' WHERE id_enlace='$key'";
			$connection = mysql_connect($this->HOST, $this->USERNAME, $this->PASSWORD);
			$SelectedDB = mysql_select_db($this->DBNAME);
			$result = mysql_query($UpdateRecords); 
			mysql_close($connection);
	...
	function actualizar_item_tabla_temas($key,$contenido,$idioma) {
		...
		if ($idioma=='es') {
			$UpdateRecords = "UPDATE temas SET tema='$contenido' WHERE id_tema='$key'";
			$connection = mysql_connect($this->HOST, $this->USERNAME, $this->PASSWORD);
			$SelectedDB = mysql_select_db($this->DBNAME);
			$result = mysql_query($UpdateRecords); 
			mysql_close($connection);
		} else {
			$UpdateRecords = "UPDATE temas SET tema_$idioma='$contenido' WHERE id_tema='$key'";
			$connection = mysql_connect($this->HOST, $this->USERNAME, $this->PASSWORD);
			$SelectedDB = mysql_select_db($this->DBNAME);
			$result = mysql_query($UpdateRecords); 
			mysql_close($connection);
	...
	function actualizar_item_tabla_temas_tmp($key,$contenido,$idioma) {
		...
		if ($idioma=='es') {
			$UpdateRecords = "UPDATE temas_tmp SET tema='$contenido' WHERE id_tema='$key'";
			$connection = mysql_connect($this->HOST, $this->USERNAME, $this->PASSWORD);
			$SelectedDB = mysql_select_db($this->DBNAME);
			$result = mysql_query($UpdateRecords); 
			mysql_close($connection);
		} else {
			$UpdateRecords = "UPDATE temas_tmp SET tema_$idioma='$contenido' WHERE id_tema='$key'";
			$connection = mysql_connect($this->HOST, $this->USERNAME, $this->PASSWORD);
			$SelectedDB = mysql_select_db($this->DBNAME);
			$result = mysql_query($UpdateRecords); 
			mysql_close($connection);
	...
	function actualizar_item_tabla_subtemas($key,$contenido,$idioma) {
		...
		if ($idioma=='es') {
			$UpdateRecords = "UPDATE subtemas SET subtema='$contenido' WHERE id_subtema='$key'";
			$connection = mysql_connect($this->HOST, $this->USERNAME, $this->PASSWORD);
			$SelectedDB = mysql_select_db($this->DBNAME);
			$result = mysql_query($UpdateRecords); 
			mysql_close($connection);
		} else {
			$UpdateRecords = "UPDATE subtemas SET subtema_$idioma='$contenido' WHERE id_subtema='$key'";
			$connection = mysql_connect($this->HOST, $this->USERNAME, $this->PASSWORD);
			$SelectedDB = mysql_select_db($this->DBNAME);
			$result = mysql_query($UpdateRecords); 
			mysql_close($connection);
	...
	function actualizar_item_tabla_subtemas_tmp($key,$contenido,$idioma) {
		...
		if ($idioma=='es') {
			$UpdateRecords = "UPDATE subtemas_tmp SET subtema='$contenido' WHERE id_subtema='$key'";
			$connection = mysql_connect($this->HOST, $this->USERNAME, $this->PASSWORD);
			$SelectedDB = mysql_select_db($this->DBNAME);
			$result = mysql_query($UpdateRecords); 
			mysql_close($connection);
		} else {
			$UpdateRecords = "UPDATE subtemas_tmp SET subtema_$idioma='$contenido' WHERE id_subtema='$key'";
			$connection = mysql_connect($this->HOST, $this->USERNAME, $this->PASSWORD);
			$SelectedDB = mysql_select_db($this->DBNAME);
			$result = mysql_query($UpdateRecords); 
			mysql_close($connection);
	...
	function actualizar_item_tabla_material($key,$contenido,$idioma,$tabla,$campo,$id) {
		...
		if ($idioma=='es') {
			$UpdateRecords = "UPDATE $tabla SET $campo='$contenido' WHERE $id='$key'";
			$connection = mysql_connect($this->HOST, $this->USERNAME, $this->PASSWORD);
			$SelectedDB = mysql_select_db($this->DBNAME);
			$result = mysql_query($UpdateRecords); 
			mysql_close($connection);
			...
			$UpdateRecords = "UPDATE $tabla SET $valor='$contenido' WHERE $id='$key'";
			$connection = mysql_connect($this->HOST, $this->USERNAME, $this->PASSWORD);
			$SelectedDB = mysql_select_db($this->DBNAME);
			$result = mysql_query($UpdateRecords); 
			mysql_close($connection);
	...
	function actualizar_item_noticia($id_noticia,$campo,$contenido,$idioma) {
		...
		if ($idioma=='es') {
			...
			SET $campo='$contenido', fecha_modificacion='$fecha'
			...
			$valor=$campo.'_'.$idioma;
			$UpdateRecords = "UPDATE noticias 
			SET $valor='$contenido',fecha_modificacion='$fecha'
			WHERE id_noticia='$id_noticia'";
			$connection = mysql_connect($this->HOST, $this->USERNAME, $this->PASSWORD);
			$SelectedDB = mysql_select_db($this->DBNAME);
			$result = mysql_query($UpdateRecords); 
	...
	function actualizar_item_eu($id_item,$campo,$contenido,$idioma) {
		
		$timestamp=time();
		$fecha=date("Y-m-d H:i:s",$timestamp);
		
		if ($idioma=='es') {
			$UpdateRecords = "UPDATE ejemplos_uso 
			SET $campo='$contenido', fecha_modificacion='$fecha'
			WHERE id_eu='$id_item'";
			$connection = mysql_connect($this->HOST, $this->USERNAME, $this->PASSWORD);
			$SelectedDB = mysql_select_db($this->DBNAME);
...
//*********************************************************//
	...
	function listar_imagenes($registrado,$id_tipo,$letra,$filtrado,$orden,$id_subtema) {
		...
		$query = "SELECT DISTINCT palabra_imagen.*, imagenes.*, palabras.* $subtema_tabla
...
//*********************************************************//
	...
	function listar_pictogramas_idioma($registrado,$id_tipo,$letra,$filtrado,$orden,$id_subtema,$id_idioma,$tipo_pictograma) {
		...
		$query = "SELECT DISTINCT palabra_imagen.*, imagenes.*, palabras.*, traducciones.* $subtema_tabla
		...
		AND traducciones.traduccion <> 'sin traduccion'
		$sql_letra
		$sql_tipo
		$sql_subtema	
...
//******************************************************************************//	
	...
	function listar_diccionario_palabras_con_imagenes_por_tipo_imagen($id_tipo,$letra,$id_tipo_imagen) {
		...
		$query = "SELECT DISTINCT palabra_imagen.*, imagenes.*, palabras.*
		FROM palabra_imagen, imagenes, palabras
		WHERE imagenes.estado=1
		AND palabras.id_palabra=palabra_imagen.id_palabra
		AND palabra_imagen.id_imagen=imagenes.id_imagen
...
//******************************************************************************//	
	...
	function listar_diccionario_palabras_por_tipos_con_imagenes_limit($sql,$letra,$inicial,$cantidad) {
		...
		$query = "SELECT DISTINCT palabras.*, palabra_imagen.*, imagenes.*
	...
	function listar_diccionario_idiomas_palabras_por_tipos_con_imagenes_limit($sql,$letra,$inicial,$cantidad,$id_idioma) {
		...
		$query = "SELECT DISTINCT traducciones.*, palabra_imagen.*, imagenes.*
...
//******************************************************************************//	
	...
	function listar_tipos_imagen_seleccionados($pictogramas_color,$pictogramas_byn,$fotografia,$videos_lse,$lse_color,$lse_byn) {
		...
		if ($lse_color==0) { $sql_lse_color=' AND id_tipo !=12 '; } else {  $sql_videos_lse=''; }
...
//******************************************************************************//	
	...
	function datos_imagen($id_imagen) {
		$query = "SELECT imagenes.*, palabra_imagen.*, palabras.*, tipos_imagen.*,colaboradores.*, licencias.*, autores.*
...
//******************************************************************************//	
	...
	function datos_simbolo_arasaac($id_simbolo) {
		$query = "SELECT simbolos.*, tipos_simbolos.*, palabras.*, imagenes.*
...
//******************************************************************************//	
	...
	function imagenes_disponibles($id_palabra) {
		$query = "SELECT palabras.*, tipos_palabra.*, imagenes.*, palabra_imagen.*
...
//******************************************************************************//	
	...
	function imagenes_disponibles_idioma_tipo($id_traduccion,$id_tipo,$id_idioma) {
		$query = "SELECT traducciones.*, imagenes.*, palabra_imagen.*
...
//******************************************************************************//	
	...
	function imagenes_disponibles_solo_por_tipo($id_tipo,$limite) {
		$query = "SELECT palabras.*, imagenes.*, palabra_imagen.*,autores.*,licencias.*
...
//******************************************************************************//	
	...
	function imagenes_disponibles_idioma_tipo_por_tag($tag,$id_tipo,$id_idioma) {
		$query = "SELECT imagenes.*, palabra_imagen.*, traducciones.*
...
// 							AÑADIR NUEVA IMAGEN                        //
//******************************************************************************//
	function add_new_picture($id_usuario,$id_tipo_imagen,$imagen,$id_palabra,$estado,$registrado,$id_autor,$id_licencia,$tags,$tipo_pictograma,$validos_senyalectica) {
		$timestamp=time();
		$fecha=date("Y-m-d H:i:s",$timestamp);
		$fecha_modificacion=date("Y-m-d H:i:s",$timestamp);
		...
		$connection = mysql_connect($this->HOST, $this->USERNAME, $this->PASSWORD);
		$SelectedDB = mysql_select_db($this->DBNAME);
		$ssql = "INSERT INTO imagenes(id_colaborador,id_tipo_imagen,fecha_creacion, ultima_modificacion, estado, registrado,id_autor,id_licencia,tags_imagen,tipo_pictograma,validos_senyalectica) 
			VALUES ('$id_usuario', '$id_tipo_imagen', '$fecha', '$fecha', '$estado','$registrado','$id_autor','$id_licencia','$tags','$tipo_pictograma','$validos_senyalectica')";
