...
?>
    <title>ARASAAC: <?php echo $translate['catalogo_videos_lse']; ?></title>
...
<div class="body_content"> 
  ...
  <h4><img src="images/ico_lse.jpg" alt="<?php echo $translate['accesible_personas_sordas']; ?>" title="<?php echo $translate['accesible_personas_sordas']; ?>" />&nbsp;<?php echo $translate['catalogo_videos_lse']; ?>:</h4>
  <div id="principal">
      	...
      	<?php 
		  	if (isset($_GET['id']) && $_GET['id'] !='') { 
				require('ver_ficha.php'); 
			  	...
			  	require('resultados_catalogos_videos.php');
			  } 
		?>
    </form>
  </div>
